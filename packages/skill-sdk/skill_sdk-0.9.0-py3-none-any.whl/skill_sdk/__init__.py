""" Magenta skill SDK for Python """

import importlib
import contextlib
from typing import Any, Callable, ContextManager

from .skill import Skill, initialize, intent_handler
from .intents import Context, context
from .sessions import Session
from .responses import Card, Response, Reprompt, ask, tell, ask_freetext


def lazy_load(module: str, attr: str) -> Callable[..., ContextManager]:
