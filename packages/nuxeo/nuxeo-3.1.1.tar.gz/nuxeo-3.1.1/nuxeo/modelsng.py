...
class Batch(Model):
    ...
    def get_uploader(self, blob: "Blob", **kwargs: Any) -> "Blob":
        """
    ...
    def upload(self, blob: "Blob", **kwargs: Any) -> "Blob":
        """
        Upload a blob.
    ...
    def execute(self, operation: str, file_idx: Optional[int] = None, params: Any = None) -> Any:
        """
    ...
    def attach(self, doc: str, file_idx: Optional[int] = None) -> Any:
        """
