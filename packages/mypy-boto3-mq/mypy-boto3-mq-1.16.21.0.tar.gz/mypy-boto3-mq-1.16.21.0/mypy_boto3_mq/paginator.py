...
class ListBrokersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBrokers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.21/reference/services/mq.html#MQ.Paginator.ListBrokers.paginate)
        """
