...
[boto3.CodeStarconnections 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/codestar-connections.html#CodeStarconnections) service
compatible with
