...
from .chart_elements import (
    ...
    ChartStructline, ChartDifferential, ChartExtension, ChartEdge, ChartEdgeStyle
)
...
class SseqChart:
    ...
    def add_class(self, *degree : int) -> ChartClass:
        ...
        c.set_style(slice(None), self.default_class_style)
        self._commit_class(c)
        return c
    ...
    def add_structline(self, source_arg : ChartClassArg, target_arg : ChartClassArg) -> ChartStructline:
        ...
        e.set_style(slice(None), self._default_structline_style)
        self._commit_edge(e)
        return e
