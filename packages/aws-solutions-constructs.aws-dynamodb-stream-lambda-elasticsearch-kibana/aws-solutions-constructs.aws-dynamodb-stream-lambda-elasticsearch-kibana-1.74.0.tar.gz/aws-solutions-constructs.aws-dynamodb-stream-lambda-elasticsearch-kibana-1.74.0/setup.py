    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_dynamodb_stream_lambda_elasticsearch_kibana._jsii": [
            "aws-dynamodb-stream-lambda-elasticsearch-kibana@1.74.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_dynamodb_stream_lambda_elasticsearch_kibana": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.core==1.74.0",
        "aws-solutions-constructs.aws-dynamodb-stream-lambda==1.74.0",
        "aws-solutions-constructs.aws-lambda-elasticsearch-kibana==1.74.0",
