    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_dynamodb_stream_lambda_elasticsearch_kibana._jsii": [
            "aws-dynamodb-stream-lambda-elasticsearch-kibana@1.72.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_dynamodb_stream_lambda_elasticsearch_kibana": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-event-sources==1.72.0",
        "aws-cdk.aws-lambda==1.72.0",
        "aws-cdk.aws-sqs==1.72.0",
        "aws-cdk.core==1.72.0",
        "aws-solutions-constructs.aws-dynamodb-stream-lambda==1.72.0",
        "aws-solutions-constructs.aws-lambda-elasticsearch-kibana==1.72.0",
