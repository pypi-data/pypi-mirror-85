...
class DescribeScalingPlanResourcesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeScalingPlanResources.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/autoscaling-plans.html#AutoScalingPlans.Paginator.DescribeScalingPlanResources.paginate)
        """
...
class DescribeScalingPlansPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeScalingPlans.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/autoscaling-plans.html#AutoScalingPlans.Paginator.DescribeScalingPlans.paginate)
        """
