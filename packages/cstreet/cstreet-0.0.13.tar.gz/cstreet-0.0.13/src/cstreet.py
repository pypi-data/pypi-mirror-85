...
class CStreetData(object):
    ...
    class params_object:
        ...
        def __init__(self):
            ...
            self.__Threshold_MinCellNumofStates=50
    ...
    @except_output
    @function_timer
    @params_filter(['pca_n','knn_n','resolution','normalize','log'])
    def cell_clusters(self,**kwargs):

        self.__create_folder("SupplementaryFigures")

        pca_n = self.params.CellClusterParam_PCAn = kwargs.setdefault('pca_n', self.params.CellClusterParam_PCAn)
        knn_n = self.params.CellClusterParam_kNNn = kwargs.setdefault('knn_n', self.params.CellClusterParam_kNNn)
        resolution = self.params.CellClusterParam_Resolution=kwargs.setdefault("resolution",self.params.CellClusterParam_Resolution)
        normalize_flag = self.params.Switch_Normalize=kwargs.setdefault("normalize",self.params.Switch_Normalize)
        log_flag = self.params.Switch_LogTransform=kwargs.setdefault("log",self.params.Switch_LogTransform)
    ...
    def get_knn_within(self,**kwargs):
        pca_n=self.params.WithinTimePointParam_PCAn=kwargs.setdefault("pca_n",self.params.WithinTimePointParam_PCAn)
        k=self.params.WithinTimePointParam_kNNn=kwargs.setdefault("k",self.params.WithinTimePointParam_kNNn)
    ...
    def get_knn_between(self,**kwargs):
        pca_n=self.params.BetweenTimePointParam_PCAn=kwargs.setdefault("pca_n",self.params.BetweenTimePointParam_PCAn)
        k=self.params.BetweenTimePointParam_kNNn=kwargs.setdefault("k",self.params.BetweenTimePointParam_kNNn)
