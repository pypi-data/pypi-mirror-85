...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.7.0-alpha.1604936729+2bf06a7b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.7.0-alpha.1604936729+2bf06a7b`
                """)
            else:
                raise
