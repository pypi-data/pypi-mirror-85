...
class EnvEncoder(object):
    ...
    def __init__(self,
        ...
        if backend == "GPT":
            from train_gpt import _Z, _H
        elif backend == "GPT1D":
            from train_gpt1d import _Z, _H
            from navrep.tools.wdataset import LIDAR_NORM_FACTOR
        elif backend == "VAE1DLSTM":
            from train_vae1dlstm import _Z, _H
            from navrep.tools.wdataset import LIDAR_NORM_FACTOR
        elif backend == "VAELSTM":
            from train_vaelstm import _Z, _H
        elif backend == "VAE_LSTM":
            from train_vae import _Z
            from train_rnn import _H
        elif backend == "VAE1D_LSTM":
            from train_vae1d import _Z
            from train_rnn import _H
            from train_vae1d import MAX_LIDAR_DIST as LIDAR_NORM_FACTOR
        self._Z = _Z
        self._H = _H
