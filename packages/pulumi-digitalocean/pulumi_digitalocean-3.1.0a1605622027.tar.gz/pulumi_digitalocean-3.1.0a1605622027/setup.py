...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.1.0-alpha.1605622027+c69b1a80'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.1.0-alpha.1605622027+c69b1a80`
                """)
            else:
                raise
