...
#        plot.set_title('Title',size=20)
        plot.set_xticks(ind)
        plot.set_xticklabels(('Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep','Oct', 'Nov', 'Dec','Year/10'),fontsize=10,rotation='45')                       
...
#inVar(nVar,nMonth)
    def plotMonthlyBalance(self,inVar,outVar,legends,myLabel,nameFile,unit,yearlyFactor=0,useYear=False,plotEmf=False):
...
#        plot.set_title('Title',size=20)
        plot.set_xticks(ind)
        plot.set_xticklabels(('Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep','Oct', 'Nov', 'Dec','Year/10'),fontsize=self.sizeAxis,rotation='45')                       
