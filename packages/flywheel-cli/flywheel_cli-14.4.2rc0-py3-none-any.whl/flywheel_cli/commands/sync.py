...
def sync(args):
    ...
    src = FWThreadedSource(
        ...
        include_container_tags=(
            json.loads(args.include_container_tags)
            if args.include_container_tags
            else None
        ),
        exclude_container_tags=(
            json.loads(args.exclude_container_tags)
            if args.exclude_container_tags
            else None
        ),
