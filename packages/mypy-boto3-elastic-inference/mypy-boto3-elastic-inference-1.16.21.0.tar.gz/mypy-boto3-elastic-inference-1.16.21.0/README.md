...
[boto3.ElasticInference 1.16.21](https://boto3.amazonaws.com/v1/documentation/api/1.16.21/reference/services/elastic-inference.html#ElasticInference) service
compatible with
