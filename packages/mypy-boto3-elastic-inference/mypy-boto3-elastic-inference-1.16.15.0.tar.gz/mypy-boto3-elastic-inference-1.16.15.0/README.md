...
[boto3.ElasticInference 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/elastic-inference.html#ElasticInference) service
compatible with
