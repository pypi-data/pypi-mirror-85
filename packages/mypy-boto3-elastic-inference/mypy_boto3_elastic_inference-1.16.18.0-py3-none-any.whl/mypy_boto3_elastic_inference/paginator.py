...
class DescribeAcceleratorsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeAccelerators.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.18/reference/services/elastic-inference.html#ElasticInference.Paginator.DescribeAccelerators.paginate)
        """
