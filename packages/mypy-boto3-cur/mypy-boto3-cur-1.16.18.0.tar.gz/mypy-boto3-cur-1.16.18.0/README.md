...
[boto3.CostandUsageReportService 1.16.18](https://boto3.amazonaws.com/v1/documentation/api/1.16.18/reference/services/cur.html#CostandUsageReportService) service
compatible with
