...
[boto3.CostandUsageReportService 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/cur.html#CostandUsageReportService) service
compatible with
