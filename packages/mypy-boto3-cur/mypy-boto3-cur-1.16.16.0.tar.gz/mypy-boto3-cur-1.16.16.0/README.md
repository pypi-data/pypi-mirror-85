...
[boto3.CostandUsageReportService 1.16.16](https://boto3.amazonaws.com/v1/documentation/api/1.16.16/reference/services/cur.html#CostandUsageReportService) service
compatible with
