...
[boto3.PersonalizeRuntime 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/personalize-runtime.html#PersonalizeRuntime) service
compatible with
