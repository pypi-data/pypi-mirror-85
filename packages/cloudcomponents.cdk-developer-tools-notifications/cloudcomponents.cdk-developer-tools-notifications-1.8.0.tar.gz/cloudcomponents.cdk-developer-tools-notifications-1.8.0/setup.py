    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_developer_tools_notifications._jsii": [
            "cdk-developer-tools-notifications@1.8.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_developer_tools_notifications": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-codebuild>=1.73.0, <2.0.0",
        "aws-cdk.aws-codecommit>=1.73.0, <2.0.0",
        "aws-cdk.aws-codedeploy>=1.73.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.73.0, <2.0.0",
        "aws-cdk.aws-codestarnotifications>=1.73.0, <2.0.0",
        "aws-cdk.aws-iam>=1.73.0, <2.0.0",
        "aws-cdk.aws-lambda-event-sources>=1.73.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.73.0, <2.0.0",
        "aws-cdk.aws-sns>=1.73.0, <2.0.0",
        "aws-cdk.core>=1.73.0, <2.0.0",
        "cloudcomponents.cdk-chatops>=1.8.0, <2.0.0",
