...
class DeviceConnector:
    ...
    # TODO: Maybe in the future, make methods so that events can be sent asynchronously
    ...
    def get_window_at(self, device: Device, x: int, y: int) -> str:
    	"""
    	Returns the name of the current window at the given x and y coordinates on the given device.
    	The return value will be "Keyboard" if the coordinates are within the device's software
    	keyboard; otherwise, "Main" will be returned.
    	"""
    	...
    	if match:
    		...
    		# If the keyboard is displayed, check the given x and y coordinates against the
    		# coordinates given by the "touchable region" part of the output.
    		if match.group(1) == "true":
    			...
    			if match:
    				...
    				# if the x and y coords are within the touchable region, then return "Keyboard"
    ...
    def app_is_installed(self, device: Device, package_name: str) -> bool:
        """
