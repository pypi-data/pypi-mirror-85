...
class UserInfo:
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'open_id', 'user_nick', 'avatar', 'is_auth', 'is_new', 'owner_open_id', 'pay_price', 'pay_num', 'login_token', 'signin', 'surplus_integral', 'user_state', 'is_member', 'is_favor', 'relieve_date', 'create_date', 'modify_date']
