...
[boto3.MarketplaceCommerceAnalytics 1.16.14](https://boto3.amazonaws.com/v1/documentation/api/1.16.14/reference/services/marketplacecommerceanalytics.html#MarketplaceCommerceAnalytics) service
compatible with
