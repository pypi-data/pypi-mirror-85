...
[boto3.MarketplaceCommerceAnalytics 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/marketplacecommerceanalytics.html#MarketplaceCommerceAnalytics) service
compatible with
