...
class CfnDataSource(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        data_source_configuration: typing.Union["CfnDataSource.DataSourceConfigurationProperty", _IResolvable_a771d0ef],
    ...
    def data_source_configuration(
        self,
    ) -> typing.Union["CfnDataSource.DataSourceConfigurationProperty", _IResolvable_a771d0ef]:
    ...
    def data_source_configuration(
        self,
        value: typing.Union["CfnDataSource.DataSourceConfigurationProperty", _IResolvable_a771d0ef],
    ) -> None:
