...
from ..aws_lambda import (
    AssetCode as _AssetCode_624a9fe0,
...
class Bundling(metaclass=jsii.JSIIMeta, jsii_type="monocdk.aws_lambda_nodejs.Bundling"):
...
@jsii.data_type(
    jsii_type="monocdk.aws_lambda_nodejs.ParcelBaseOptions",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="monocdk.aws_lambda_nodejs.ParcelOptions",
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_FunctionOptions_dc75a392, ParcelBaseOptions],
    name_mapping={
...
class NodejsFunctionProps(_FunctionOptions_dc75a392, ParcelBaseOptions):
    def __init__(
        self,
        *,
        max_event_age: typing.Optional[_Duration_070aa057] = None,
