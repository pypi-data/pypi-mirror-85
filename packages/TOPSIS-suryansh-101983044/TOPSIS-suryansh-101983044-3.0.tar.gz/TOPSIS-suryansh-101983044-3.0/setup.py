...
setup(
  ...
  download_url = 'https://github.com/suryanshbhar/TOPSIS-suryansh-101983044/archive/V3.0.tar.gz',    # I explain this later on
  keywords = ['version 3','SIMPLE', 'TOPSIS', 'DATA SCIENCE','MULTI DECISION CRITERIA'],   # Keywords that define your package best
