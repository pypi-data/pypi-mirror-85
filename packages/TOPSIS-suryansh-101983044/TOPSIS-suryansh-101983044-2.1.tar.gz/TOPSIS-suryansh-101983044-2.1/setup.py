...
setup(
  ...
  download_url = 'https://github.com/suryanshbhar/TOPSIS-suryansh-101983044/archive/2.1.tar.gz',    # I explain this later on
  keywords = ['version 2.1','SIMPLE', 'TOPSIS', 'DATA SCIENCE','MULTI DECISION CRITERIA'],   # Keywords that define your package best
