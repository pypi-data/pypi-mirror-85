...
If you want to edit the .json files in the tunings directory, you will need to create a volume and then edit the files in your volumes mount point:

```
$  docker volume create  TUNINGS
$  docker volume inspect TUNINGS
```

Remember to map your volume to your container at runtime:

```
$  docker run -t -v TUNINGS:/usr/local/fretboard/tunings synestematic/kord  C --scale major
```
