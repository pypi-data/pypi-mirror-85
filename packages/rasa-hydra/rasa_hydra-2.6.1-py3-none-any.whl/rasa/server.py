...
def create_app(
    ...
    async def ready(request: Request):
        ...
        try:
            ...
            elif endpoints.action and services_status[0] and services_status[0].status != 200:
                raise ErrorResponse(500, "DucklingConnectionError", "Rasa Duckling is not ready yet.")
            elif endpoints.duckling and services_status[1] and services_status[1].status != 200:
                raise ErrorResponse(500, "ActionConnectionError", "Action server is not ready yet.")
            elif endpoints.idp and services_status[2] and services_status[2].status != 200:
                raise ErrorResponse(500, "IDPConnectionError", f'IDP is not ready yet.')
            elif endpoints.upm and services_status[3] and services_status[3].status != 200:
