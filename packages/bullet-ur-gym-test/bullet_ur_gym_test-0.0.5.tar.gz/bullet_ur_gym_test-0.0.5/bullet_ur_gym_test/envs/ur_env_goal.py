...
class UREnv(gym.GoalEnv):
    ...
    def _get_observation_space(self):
        ...
        return spaces.Dict(dict(
            desired_goal=spaces.Box(-np.inf, np.inf, shape=self.target.shape, dtype='float32'),
            achieved_goal=spaces.Box(-np.inf, np.inf, shape=position.shape, dtype='float32'),
