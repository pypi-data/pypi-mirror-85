...
[boto3.ForecastQueryService 1.16.21](https://boto3.amazonaws.com/v1/documentation/api/1.16.21/reference/services/forecastquery.html#ForecastQueryService) service
compatible with
