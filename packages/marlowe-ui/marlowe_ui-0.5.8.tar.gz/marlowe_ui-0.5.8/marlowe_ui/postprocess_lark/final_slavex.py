...
slvx_start: slvx_stat_anal slvx_rejected slvx_repeated slvx_timeorder slvx_encounter_prob\
    slvx_nondisp_collision slvx_vacancy_dist
'''
...
class Transformer(lark.Transformer):
    ...
    def slvx_stat_anal(self, args):
        ...
        for v in args:
            if v:
                obj.update(v)
        self.context.mobj['Statistical Analysis from Cascades'] = obj
        self.context.mobj['Statistical Analysis from Cascades']['Number of Cascades'] = self.number_of_cascade
    ...
    def slvx_timeorder_hist(self, args):
        ...
        if args[1].data == 'slvx_timeorder_hist_negative':
            obj['Negative time values'] = args[1].children[1]
        obj['data'] = args[-1].children

        return {'Time Order of Collisions': obj}
