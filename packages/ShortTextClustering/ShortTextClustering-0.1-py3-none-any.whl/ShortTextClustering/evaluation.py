...
from ShortTextClustering.sentenceEmbedding import getEmbeddings
...
class EvaluateDataset(object):
    ...
    def run_iter_dbscan(self, df, dist, max_iter, min_sample, delta_distance, delta_minimum_samples):
        """
            ...
            try:
                ...
                if algorithm == 'ITER_DBSCAN':
                    self.run_iter_dbscan(self.df, dist=all_parameters[i]['distance'],
                                         ...
                                         delta_distance=all_parameters[i]['delta_distance'],
                                         delta_minimum_samples=all_parameters[i]['delta_minimum_samples'])
