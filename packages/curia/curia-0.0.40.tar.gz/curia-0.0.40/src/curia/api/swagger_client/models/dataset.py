...
class Dataset(object):
    ...
    swagger_types = {
        ...
        'intervention_timelines': 'list[Timeline]',
        'outcome_timelines': 'list[Timeline]',
        'created_at': 'datetime',
        'updated_at': 'datetime',
        'version': 'float'
    }
    ...
    attribute_map = {
        ...
        'intervention_timelines': 'interventionTimelines',
        'outcome_timelines': 'outcomeTimelines',
        'created_at': 'createdAt',
        'updated_at': 'updatedAt',
        'version': 'version'
    }

    def __init__(self, id=None, name=None, description=None, type=None, location=None, file_content_type=None, file_size=None, athena_execution_id=None, dataset_results=None, organization_id=None, model_datasets=None, intervention_timelines=None, outcome_timelines=None, created_at=None, updated_at=None, version=None):  # noqa: E501
        ...
        self._intervention_timelines = None
        self._outcome_timelines = None
        ...
        if intervention_timelines is not None:
            self.intervention_timelines = intervention_timelines
        if outcome_timelines is not None:
            self.outcome_timelines = outcome_timelines
    ...
    @property
    def intervention_timelines(self):
        """Gets the intervention_timelines of this Dataset.  # noqa: E501


        :return: The intervention_timelines of this Dataset.  # noqa: E501
        :rtype: list[Timeline]
        """
        return self._intervention_timelines

    @intervention_timelines.setter
    def intervention_timelines(self, intervention_timelines):
        """Sets the intervention_timelines of this Dataset.


        :param intervention_timelines: The intervention_timelines of this Dataset.  # noqa: E501
        :type: list[Timeline]
        """

        self._intervention_timelines = intervention_timelines

    @property
    def outcome_timelines(self):
        """Gets the outcome_timelines of this Dataset.  # noqa: E501


        :return: The outcome_timelines of this Dataset.  # noqa: E501
        :rtype: list[Timeline]
        """
        return self._outcome_timelines

    @outcome_timelines.setter
    def outcome_timelines(self, outcome_timelines):
        """Sets the outcome_timelines of this Dataset.


        :param outcome_timelines: The outcome_timelines of this Dataset.  # noqa: E501
        :type: list[Timeline]
        """

        self._outcome_timelines = outcome_timelines
