...
[boto3.LexModelBuildingService 1.16.16](https://boto3.amazonaws.com/v1/documentation/api/1.16.16/reference/services/lex-models.html#LexModelBuildingService) service
compatible with
