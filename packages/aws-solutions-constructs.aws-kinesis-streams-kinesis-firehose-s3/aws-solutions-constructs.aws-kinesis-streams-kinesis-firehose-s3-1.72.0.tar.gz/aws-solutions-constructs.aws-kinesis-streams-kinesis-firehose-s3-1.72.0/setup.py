    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_kinesis_streams_kinesis_firehose_s3._jsii": [
            "aws-kinesisstreams-kinesisfirehose-s3@1.72.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_kinesis_streams_kinesis_firehose_s3": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.core==1.72.0",
        "aws-solutions-constructs.aws-kinesis-firehose-s3==1.72.0",
        "aws-solutions-constructs.aws-kinesis-streams-lambda==1.72.0",
