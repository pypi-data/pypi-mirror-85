...
class Youtube:
    ...
    def channel_detail(self, channel_id):
        ...
        if check_data:
            ...
            return_data["viewCount"] = check_data['statistics'].get('viewCount', 0)
            return_data["subscriberCount"] = check_data['statistics'].get('subscriberCount', 0)
            return_data["videoCount"] = check_data['statistics'].get('videoCount', 0)
            return_data["commentCount"] = check_data['statistics'].get('commentCount', 0)
