...
class CodeBindingExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [CodeBindingExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.18/reference/services/schemas.html#Schemas.Waiter.CodeBindingExists.wait)
        """
