...
class JobCompleteWaiter(Boto3Waiter):
    ...
    def wait(self, Id: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [JobComplete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/elastictranscoder.html#ElasticTranscoder.Waiter.JobComplete.wait)
        """
