...
# def mainrun(fname_setting):
# 	"""
# 	Run main script
# 	:param name_setting: filename for settings file
# 	"""
# 	# 	#global fname_settings
# 	# 	if os.path.isfile(fname_setting):
# 	# 		sys.argv.append(file_setting)
# 	# 	else:
# 	# 		sys.argv.append('settings.yaml')
# 	# 		print("Warning. No settings file specified, using settings in: " + fname_settings)
# 	# 	print('fname_settings = ', fname_settings)
