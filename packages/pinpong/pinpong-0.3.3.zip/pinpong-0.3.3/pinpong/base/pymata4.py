...
class Pymata4(threading.Thread):
    ...
    def __init__(self, com_port=None, baud_rate=115200,
        ...
        self.dfrobot_dispatch.update({PrivateConstants.SUB_MESSAGE_HEARTRATE:{}})
    ...
    def set_audio_init(self, strobe_pin, RST_pin, DC_pin):
        self.dfrobot_dispatch[PrivateConstants.SUB_MESSAGE_18B20][PrivateConstants.AUDIO_VALUE] = [0 for i in range(7)]
        data = [PrivateConstants.SUB_MESSAGE_AUDIO, PrivateConstants.AUDIO_INIT, strobe_pin, RST_pin, DC_pin]
        self._send_sysex(PrivateConstants.DFROBOT_MESSAGE, data)
    
    def set_hx711_init(self, dout_pin, sck_pin, scale):
        self.dfrobot_dispatch[PrivateConstants.SUB_MESSAGE_HX711][dout_pin] = 0.0
        data = [PrivateConstants.SUB_MESSAGE_HX711, PrivateConstants.HX711_INIT, dout_pin, sck_pin, (scale >> 7)&0x7f, scale &0x7f]
        self._send_sysex(PrivateConstants.DFROBOT_MESSAGE, data)
    ...
    def hx711_read_weight(self, dout_pin):
        data = [PrivateConstants.SUB_MESSAGE_HX711, PrivateConstants.HX711_READ]
        self._send_sysex(PrivateConstants.DFROBOT_MESSAGE, data)
        time.sleep(0.3)
    ...
    def audio_analyzer_read_freq(self):
        data = [PrivateConstants.SUB_MESSAGE_AUDIO, PrivateConstants.AUDIO_read]
        self._send_sysex(PrivateConstants.DFROBOT_MESSAGE, data)
        time.sleep(0.3)
        return self.dfrobot_dispatch[PrivateConstants.SUB_MESSAGE_18B20][PrivateConstants.AUDIO_VALUE]
        
    def ds18b20_read(self, pin_number):
        data = [PrivateConstants.SUB_MESSAGE_18B20,PrivateConstants.DS18B20_READ, pin_number]
        self._send_sysex(PrivateConstants.DFROBOT_MESSAGE, data)
        time.sleep(0.2)
        temp = self.dfrobot_dispatch[PrivateConstants.SUB_MESSAGE_IR][pin_number]
        if temp == 85:
          return 0 
        else:
          return temp
    ...
    def _dfrobot_message(self, data):
        ...
        if data[0] == PrivateConstants.SUB_MESSAGE_I2CSCAN:
            ...
            pin_number = data[1]
            self.dfrobot_dispatch[PrivateConstants.SUB_MESSAGE_IR][pin_number] = temp
            ...
            for i in range(0,14,2):
              ...
              value.append(tmp)
            self.dfrobot_dispatch[PrivateConstants.SUB_MESSAGE_18B20][PrivateConstants.AUDIO_VALUE] = value
