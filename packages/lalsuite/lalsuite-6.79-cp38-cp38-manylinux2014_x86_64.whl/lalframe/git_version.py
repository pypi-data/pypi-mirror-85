...
id = "2439365b5a320735efaf7171b37738032dcf7b6b"
date = "2020-11-12 20:30:25 +0000"
branch = "None"
tag = "lalsuite-v6.79"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "2439365b5a320735efaf7171b37738032dcf7b6b":
        return
    msg = "Program id (2439365b5a320735efaf7171b37738032dcf7b6b) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
