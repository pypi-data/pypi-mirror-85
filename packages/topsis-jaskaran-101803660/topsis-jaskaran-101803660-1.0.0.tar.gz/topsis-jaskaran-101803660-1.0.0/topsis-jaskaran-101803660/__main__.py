...
def main():
    ...
    if len(sys.argv) != 5:
        ...
        print ("Usages: python topsis-jaskaran-101803660 <InputDataFile> <Weights> <Impacts> <ResultFileName>")
        print ("Example: python topsis-jaskaran-101803660 inputfile.csv “1,1,1,2” “+,+,-,+” result.csv")
        sys.exit(0)
    ...
    current_time = str(time.strftime("%Y%m%d", current_time))

    outputTable.to_csv(outputFile + current_time+'.csv',index=False)
