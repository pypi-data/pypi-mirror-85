...
def create(engine, snmp_manager=None):
    ...
    :type snmp_manager: :py:class:`v1_11_5.web.vo.SNMPManager`
    :rtype: ``TEXT_TYPE``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_11_5.web.objects.SNMPManager.SNMPManager`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_11_5.web.vo.SNMPManager`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_11_5.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`v1_11_5.web.vo.SNMPManager`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/service/snmp/manager"
    response = engine.get(url)
