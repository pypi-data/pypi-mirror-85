    ...
    def __init__(
        ...
        *,
        ...
        options = TerraformModuleOptions(
            source=source, providers=providers, version=version
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"source": "source", "providers": "providers", "version": "version"},
)
...
class TerraformOutput(
    ...
    def depends_on(
        self,
        value: typing.Optional[typing.List["TerraformResource"]],
    ) -> None:
        jsii.set(self, "dependsOn", value)
    ...
    def __init__(
        ...
        *,
        ...
        options = TerraformHclModuleOptions(
            variables=variables, source=source, providers=providers, version=version
        )
