...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '1.1.0-alpha.1603381655+a74fb2a9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 1.1.0-alpha.1603381655+a74fb2a9`
                """)
            else:
                raise
