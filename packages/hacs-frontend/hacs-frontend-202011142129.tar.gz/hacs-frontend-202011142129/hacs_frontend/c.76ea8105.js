import{_ as s,H as e,p as t,w as i,a3 as o,h as a,l as r,d as n,V as l,W as c,s as d,g as h,c as p}from"./e.b4de010b.js";import{m as u}from"./c.95b8e8d8.js";import"./c.ee0d3f21.js";import"./c.09712f4b.js";import"./c.2001a25c.js";import{u as m}from"./c.327e6704.js";let _=s([p("hacs-update-dialog")],(function(s,e){return{F:class extends e{constructor(...e){super(...e),s(this)}},d:[{kind:"field",decorators:[t()],key:"repository",value:void 0},{kind:"field",decorators:[t()],key:"_updating",value:()=>!1},{kind:"field",decorators:[t()],key:"_error",value:void 0},{kind:"field",decorators:[t()],key:"_releaseNotes",value:()=>[]},{kind:"field",key:"_getRepository",value:()=>i((s,e)=>null==s?void 0:s.find(s=>s.id===e))},{kind:"method",key:"firstUpdated",value:async function(){const s=this._getRepository(this.repositories,this.repository);"commit"!==s.version_or_commit&&(this._releaseNotes=await o(this.hass,s.id),this._releaseNotes=this._releaseNotes.filter(e=>e.tag>s.installed_version)),this.hass.connection.subscribeEvents(s=>this._error=s.data,"hacs/error")}},{kind:"method",key:"render",value:function(){if(!this.active)return a``;const s=this._getRepository(this.repositories,this.repository);return a`
      <hacs-dialog
        .active=${this.active}
