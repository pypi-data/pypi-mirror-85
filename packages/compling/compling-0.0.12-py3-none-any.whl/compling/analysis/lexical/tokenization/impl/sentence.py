...
class Sentence(abcsent.Sentence):
    ...
    def named_entities(self) -> List[Dict[str, Union[str, int]]]:
        ...
        # Examples: Donald Trump __Donald_Trump__ made his speech in New York __New_York__
        # we don't want ngrams_entities: [{'start': 0, 'end': 1, 'text': 'Donald Trump'}, {'start': 2, 'end': 2, 'text': 'Donald Trump'}, {'start': 7, 'end': 8, 'text': 'New York'}, {'start': 9, 'end': 9, 'text': 'New York'}]
        # we want ngram_entities_: [{'start': 0, 'end': 1, 'text': 'Donald Trump'}, {'start': 7, 'end': 8, 'text': 'New York'}]
