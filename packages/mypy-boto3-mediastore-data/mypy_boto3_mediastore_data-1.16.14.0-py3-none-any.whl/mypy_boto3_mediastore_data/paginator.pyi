...
class ListItemsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListItems.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.14/reference/services/mediastore-data.html#MediaStoreData.Paginator.ListItems.paginate)
        """
