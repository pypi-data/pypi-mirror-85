...
import stencila.hub
from stencila.hub.models.github_repo import GithubRepo  # noqa: E501
...
class TestGithubRepo(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = stencila.hub.models.github_repo.GithubRepo()  # noqa: E501
        if include_optional :
            return GithubRepo(
                refreshed = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                full_name = '0', 
                image_url = '0', 
                permissions = stencila.hub.models.permissions.Permissions(), 
