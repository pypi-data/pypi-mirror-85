...
import stencila.hub
from stencila.hub.models.source_polymorphic import SourcePolymorphic  # noqa: E501
...
class TestSourcePolymorphic(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = stencila.hub.models.source_polymorphic.SourcePolymorphic()  # noqa: E501
        if include_optional :
            return SourcePolymorphic(
                type = 'ElifeSource', 
                path = '0'
            )
        else :
