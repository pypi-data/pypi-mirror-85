...
import stencila.hub
from stencila.hub.models.me_feature_flags import MeFeatureFlags  # noqa: E501
...
class TestMeFeatureFlags(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = stencila.hub.models.me_feature_flags.MeFeatureFlags()  # noqa: E501
        if include_optional :
            return MeFeatureFlags(
                feature_flag = '0'
            )
        else :
            return MeFeatureFlags(
