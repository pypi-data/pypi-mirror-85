...
import stencila.hub
from stencila.hub.models.project_agent_create import ProjectAgentCreate  # noqa: E501
...
class TestProjectAgentCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = stencila.hub.models.project_agent_create.ProjectAgentCreate()  # noqa: E501
        if include_optional :
            return ProjectAgentCreate(
                id = 56, 
                type = 'user', 
                agent = 56, 
                role = 'READER'
