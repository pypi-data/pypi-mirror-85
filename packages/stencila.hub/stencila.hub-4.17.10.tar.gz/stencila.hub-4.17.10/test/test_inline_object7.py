...
import stencila.hub
from stencila.hub.models.inline_object7 import InlineObject7  # noqa: E501
...
class TestInlineObject7(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = stencila.hub.models.inline_object7.InlineObject7()  # noqa: E501
        if include_optional :
            return InlineObject7(
                project = 56, 
                app = '0', 
                host = '0', 
                node = stencila.hub.models.node.Node()
            )
        else :
            return InlineObject7(
                node = stencila.hub.models.node.Node(),
