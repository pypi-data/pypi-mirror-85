...
class MeFeatureFlags(object):
    ...
    def __init__(self, feature_flag=None, local_vars_configuration=None):  # noqa: E501
        """MeFeatureFlags - a model defined in OpenAPI"""  # noqa: E501
    ...
    def feature_flag(self):
        """Gets the feature_flag of this MeFeatureFlags.  # noqa: E501


        :return: The feature_flag of this MeFeatureFlags.  # noqa: E501
        :rtype: str
        """
    ...
    def feature_flag(self, feature_flag):
        """Sets the feature_flag of this MeFeatureFlags.


        :param feature_flag: The feature_flag of this MeFeatureFlags.  # noqa: E501
        :type feature_flag: str
        """
        if self.local_vars_configuration.client_side_validation and feature_flag is None:  # noqa: E501
            raise ValueError("Invalid value for `feature_flag`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MeFeatureFlags):
            return False
