...
"""
 ...
 using the :py:meth:`solace.messaging.messge_service.MessagingService.create_direct_message_receiver_builder()`
...
class DirectMessageReceiverBuilder(MessageReceiverBuilder):
    """
    The builder for a direct message receiver.
    """

    @abstractmethod
    def build(self, shared_subscription_group: ShareName = None) -> DirectMessageReceiver:
        """
        Creates an instance of a direct message receiver (:py:class:`solace.messaging.receiver.direct_message_receiver.DirectMessageReceiver`).
