...
class PersistentMessagePublisherBuilder(MessagePublisherBuilder):  # pylint: disable=too-many-ancestors
    """
        This class is used to configure and create instances of ``PersistentMessagePublisherBuilder``.
        The ``PersistentMessagePublisherBuilder`` builds the :py:class:`solace.messaging.publisher.persistent_message_publisher.PersistentMessagePublisher` instances.
    """

    @abstractmethod
    def build(self) -> 'PersistentMessagePublisherBuilder':
        """
          Builds a  persistent message publisher builder instance.

        Returns:
            PersistentMessagePublisherBuilder: A builder for a persistent message publisher.
        """
