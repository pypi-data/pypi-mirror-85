...
class Connectable(ABC):
    ...
    def disconnect(self):
        ...
        return until the disconnect process completes. After the disconnect process completes, the ``Messaging Service`` can be connected again by calling
        :py:meth:`solace.messaging.connections.async_connectable.AsyncConnectable.connect_async()` or :py:meth:`Connectable.connect()`.
        """
    ...
    def remove_reconnection_listener(self, listener: 'ReconnectionListener') -> "Connectable":
        ...
        Args:
            listener (): :py:class:`~solace.messaging.messaging_service.ReconnectionListener`
        """
