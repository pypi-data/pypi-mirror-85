...
from solace.messaging.config.solace_message_constants import VALUE_OUT_OF_RANGE
...
class Validation:
    """class for validating the illegal null values and the illegal regex values while given as input """
