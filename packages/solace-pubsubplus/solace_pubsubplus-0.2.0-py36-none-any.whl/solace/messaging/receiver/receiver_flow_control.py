...
"""
Module constains the abstract base class for flow control interfaces on a Persistent Message Receiver

Only persistent messaging prevent the broker from sending messages through the use of flow control methods.
"""
...
class ReceiverFlowControl(ABC):
    ...
    def pause(self):
        """
            Pause message delivery for an asynchronous message handler or stream. Message delivery can be
