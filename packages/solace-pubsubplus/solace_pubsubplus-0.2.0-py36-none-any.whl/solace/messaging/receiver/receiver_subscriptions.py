...
"""
Module contains the abstract base classes that defines the interface for synchronous subscription operations.
"""
...
class ReceiverSubscriptions(ABC):
    ...
    def add_subscription(self, another_subscription: TopicSubscription):
        """
        Request to subscribe synchronously to a given topic subscription.
    ...
    def remove_subscription(self, subscription: TopicSubscription):
        """
        Request to unsubscribe synchronously from the specified  topic subscription.
