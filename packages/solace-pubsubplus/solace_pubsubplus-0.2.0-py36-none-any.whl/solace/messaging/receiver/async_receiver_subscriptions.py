...
"""
Module contains the Abstract Base Classes that defines the interface for asynchronous subscription operations.
"""
...
class AsyncReceiverSubscriptions(ABC):
    ...
    All :py:class:`solace.messaging.receiver.message_receiver.MessageReceiver` class support both synchronous
    ...
    def add_subscription_async(self, topic_subscription: TopicSubscription) -> Future:
        """
        Request to subscribe asynchronously to a given topic subscription.
        ...
        Args:
            topic_subscription (TopicSubscription): subscription expression to subscribe to. Messages with a topic
            that matches the subscription will be directed to this client.
    ...
    def remove_subscription_async(self, topic_subscription: TopicSubscription) -> Future:
        """
        Request to unsubscribe asynchronously from a given topic subscription.
