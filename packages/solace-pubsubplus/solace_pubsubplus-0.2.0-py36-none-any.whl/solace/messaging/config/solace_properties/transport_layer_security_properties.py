...
""" Boolean property to enable (default) or disable X509 certificate validation. When enabled the certificate
received from the PubSub+ broker is validated by using certificates found in the
TRUST_STORE_PATH
"""
...
received from the PubSub+ broker must not be expired.
"""
...
enabled the certificate received from the PubSub+ broker must match the host used to connect.
"""
