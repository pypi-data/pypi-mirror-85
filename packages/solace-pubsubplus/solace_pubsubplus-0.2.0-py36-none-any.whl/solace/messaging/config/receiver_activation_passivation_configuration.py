...
class ReceiverStateChangeListener:
    ...
    def on_change(self, old_state: ReceiverState, new_state: ReceiverState, change_time_stamp: int):
        """
        ...
        Args:
            ...
            change_time_stamp(ReceiverState): The timestamp to use for the change.
        """
