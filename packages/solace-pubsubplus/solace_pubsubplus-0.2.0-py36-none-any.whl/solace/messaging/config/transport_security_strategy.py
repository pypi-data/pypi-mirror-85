...
class TransportSecurityStrategy(ABC):
    """
    Abstract class to represent a transport security strategy.

    This class exists to provide a common interface class for all TransportSecurityStrategy
    """
    ...
    def security_configuration(self) -> dict:
        """method to get the security configuration"""
        ...


class TLS(TransportSecurityStrategy):
    """Concrete Class derived from :py:class:`TransportSecurityStrategy` and extended to support TLS configuration."""
    ...
    def with_certificate_validation(self, ignore_expiration: bool,
        ...
        Args:
            ...
            trusted_common_name_list: Specifies a comma-delimited list of acceptable common names for matching with server certificates.\
