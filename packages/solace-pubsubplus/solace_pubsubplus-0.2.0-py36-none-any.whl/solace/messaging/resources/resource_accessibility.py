...
"""
Module for resource accessibility
"""
...
class ResourceAccessibility(ABC):  # pylint: disable=too-few-public-methods
    ...
    def is_exclusively_accessible(self) -> bool:
        ...
        Returns:
            bool: True if a remote resource can serve only one consumer at any one time, False if a remote resource can serve multiple consumers; each consumer is serviced in round‑robin fashion.
        """
