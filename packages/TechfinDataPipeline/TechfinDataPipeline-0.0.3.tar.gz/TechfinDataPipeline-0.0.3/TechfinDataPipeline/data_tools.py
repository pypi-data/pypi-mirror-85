...
def getListOfTables(session,connector_name):
    ...
    tables =  [['arinvoice',['_orgid', 'businesspartner_id', 'deleted', 'docissue', 'invoice_id', 'transactiontype'],True],
               ['arinvoiceinstallment',['_orgid', 'invoice_id', 'invoiceinstallment_id', 'duedatecash', 'deleted'],True],
               ...
               ['apinvoiceinstallment', ['_orgid', 'invoice_id', 'invoiceinstallment_id', 'duedatecash', 'deleted'],True],
...
def nfe_parser(downloaded_tables, invoices_df):
    '''
    ...
    if 'arinvoicebra' in downloaded_tables.keys():
...
def default_techfin_data_parser(connector, max_workers=1):
    ...
    if possible:
        ...
        ar_invoices_df = nfe_parser(downloaded_tables, ar_invoices_df)
