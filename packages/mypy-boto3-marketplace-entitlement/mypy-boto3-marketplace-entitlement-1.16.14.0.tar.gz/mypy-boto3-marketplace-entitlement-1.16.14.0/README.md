...
[boto3.MarketplaceEntitlementService 1.16.14](https://boto3.amazonaws.com/v1/documentation/api/1.16.14/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
compatible with
