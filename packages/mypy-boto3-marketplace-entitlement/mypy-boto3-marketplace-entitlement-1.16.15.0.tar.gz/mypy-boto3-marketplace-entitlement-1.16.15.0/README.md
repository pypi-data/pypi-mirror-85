...
[boto3.MarketplaceEntitlementService 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
compatible with
