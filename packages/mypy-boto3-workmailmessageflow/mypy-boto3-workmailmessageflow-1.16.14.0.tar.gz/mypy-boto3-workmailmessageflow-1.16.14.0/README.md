...
[boto3.WorkMailMessageFlow 1.16.14](https://boto3.amazonaws.com/v1/documentation/api/1.16.14/reference/services/workmailmessageflow.html#WorkMailMessageFlow) service
compatible with
