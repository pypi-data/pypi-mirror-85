...
class AlarmExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [AlarmExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.16/reference/services/cloudwatch.html#CloudWatch.Waiter.AlarmExists.wait)
        """
...
class CompositeAlarmExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [CompositeAlarmExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.16/reference/services/cloudwatch.html#CloudWatch.Waiter.CompositeAlarmExists.wait)
        """
