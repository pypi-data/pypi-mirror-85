...
{% if record.related_site %}
    <a href="{{ record.related_site.get_absolute_url }}">{{ record.related_site }}</a>
{% else %}
    —
{% endif %}
"""
...
{% if record.related_device %}
    <a href="{{ record.related_device.get_absolute_url }}">{{ record.related_device }}</a>
{% else %}
    —
{% endif %}
"""
...
{% if record.related_vm %}
    <a href="{{ record.related_vm.get_absolute_url }}">{{ record.related_vm }}</a>
{% else %}
    —
{% endif %}
"""
