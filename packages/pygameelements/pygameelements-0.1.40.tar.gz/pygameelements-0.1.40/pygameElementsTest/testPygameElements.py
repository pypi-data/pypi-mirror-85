...
class testPygameElements():
    def __init__(self, screenWidth=900, screenHeight=600, caption='PygameElement Elements Example', isFullscreen=False, desiredFrameRate=50.0):
        ...
        self.renderObjects.append(Label(self.windowSurface, 'screenShowLabel', 'lblName8', 'or', pygame.Color('black'), 850, 300))
        self.renderObjects.append(Label(self.windowSurface, 'screenShowLabel', 'lblName9', 'rotation', pygame.Color('white'), 900, 400))
