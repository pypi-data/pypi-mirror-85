...
setuptools.setup(
    ...
    download_url = 'https://github.com/QuetzalQatl/PyGameElements/blob/main/dist/pygameelements-0.1.34.tar.gz',
    keywords = ['pygame', 'element', 'gui', 'button', 'label', 'text', 'image', 'checkbox', 'inputbox', 'line', 'square', 'ellipse', 'test'],
    
    package_data={'tests': ['fonts/Ballpointprint.ttf', 'images/someimage.png', 'images/SquareExamples.png']},
