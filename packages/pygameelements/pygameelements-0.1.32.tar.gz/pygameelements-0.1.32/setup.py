...
setuptools.setup(
    ...
    download_url = 'https://github.com/QuetzalQatl/PyGameElements/blob/main/dist/pygameelements-0.1.32.tar.gz',
    keywords = ['pygame', 'element', 'gui', 'button', 'label', 'text', 'image', 'checkbox', 'inputbox', 'line', 'square', 'ellipse', 'test'],
    
    package_data={'pygameElements': ['fonts/Ballpointprint.ttf', 'images/someimage.png', 'images/SquareExamples.png', 'test.py']},
