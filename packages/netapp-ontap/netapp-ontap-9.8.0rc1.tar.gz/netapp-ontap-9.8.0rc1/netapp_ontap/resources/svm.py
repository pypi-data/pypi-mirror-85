...
Example: 02c9e252-41be-11e9-81d5-00a0986138f7 """
    ...
    """aggregates.name,aggregates.uuid,certificate.name,certificate.uuid,comment,fc_interfaces,ip_interfaces,language,name,nsswitch,snapmirror,snapshot_policy.name,snapshot_policy.uuid,state,volume_efficiency_policy.name,volume_efficiency_policy.uuid,"""
