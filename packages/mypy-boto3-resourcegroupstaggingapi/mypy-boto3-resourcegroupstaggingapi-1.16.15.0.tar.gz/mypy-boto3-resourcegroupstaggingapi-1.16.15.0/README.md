...
[boto3.ResourceGroupsTaggingAPI 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/resourcegroupstaggingapi.html#ResourceGroupsTaggingAPI) service
compatible with
