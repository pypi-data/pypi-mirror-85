...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='vrpaymentbasicpaymentstatusresponse',
            name='raw_headers',
            field=models.BaseJSONField(help_text='response header as json', verbose_name='Headers'),
        ),
        migrations.AlterField(
            model_name='vrpaymentbasicpaymentstatusresponse',
            name='result_details',
            field=models.BaseJSONField(blank=True, help_text='A container for name value pair used for enriching the response with bank-specific response details. I.e. the actual parameters used within resultDetails are bank-specific.', null=True, verbose_name='Result details'),
        ),
        migrations.AlterField(
            model_name='vrpaymentbasicpaymentstatusresponse',
            name='result_details_acquirer_response',
            field=models.BaseJSONField(blank=True, help_text='Represents the acquirer original response code retrieved from the acquirer directly.', null=True, verbose_name='Result details - Acquirer response'),
        ),
        migrations.AlterField(
            model_name='vrpaymentcheckoutresponse',
            name='other',
            field=models.BaseJSONField(blank=True, help_text="The response can also contain each of the data structures listed above, such as 'customer' and 'billingAddress'.", null=True, verbose_name='Other'),
        ),
        migrations.AlterField(
            model_name='vrpaymentcheckoutresponse',
            name='raw_content',
            field=models.BaseJSONField(help_text='response content as json', verbose_name='Content'),
        ),
        migrations.AlterField(
            model_name='vrpaymentcheckoutresponse',
            name='raw_headers',
