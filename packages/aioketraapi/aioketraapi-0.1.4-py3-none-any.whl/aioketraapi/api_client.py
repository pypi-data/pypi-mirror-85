...
import aioketraapi.models
from aioketraapi import rest
from aioketraapi.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aioketraapi.models, klass)
