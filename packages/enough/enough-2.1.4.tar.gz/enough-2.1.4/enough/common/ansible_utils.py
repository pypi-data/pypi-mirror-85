...
class Ansible(object):
    ...
    def get_variable(self, variable, host):
        ...
        :param variable: the variable to render. `dict(hostvars[inventory_hostname])`
    ...
    def get_hostvars(self, variable, *hosts):
        ...
        """
        if not variable:
            # dict is used in order to workaround https://github.com/ansible/ansible/pull/64282
            # which is fixed since ansible 2.9.1
            variable = "dict(hostvars[inventory_hostname])"
