...
def determine_original_target_nodes_if_needed(remove_empty_shapes, original_target_classes, original_shape_map):
    ...
    if original_target_classes is not None:
        for a_class in original_target_classes:
            result.add(build_shapes_name_for_class_uri(a_class))
