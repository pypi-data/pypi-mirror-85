...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.26.0-alpha.1605733747+e433fcd7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.26.0-alpha.1605733747+e433fcd7`
                """)
            else:
                raise
