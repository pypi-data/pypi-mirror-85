...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.26.0-alpha.1604929953+57e3f61d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.26.0-alpha.1604929953+57e3f61d`
                """)
            else:
                raise
