...
.. _openepda_updk_format_v0_4:

==========================================================
openEPDA uPDK |trade| Blocks - Version 0.4 (latest, draft)
==========================================================
...
:download:`csv <openEPDA_uPDK_SBB_v0.4.yaml.csv>` format. More information
...
.. include:: openEPDA_uPDK_SBB_v0.4.yaml.rst
...
:download:`yaml <openEPDA_uPDK_SBB_v0.4.yaml>`.
