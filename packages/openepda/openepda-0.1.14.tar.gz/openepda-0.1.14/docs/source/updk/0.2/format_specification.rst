...
.. _openepda_updk_format_v0_2:

=====================================================
openEPDA uPDK |trade| Blocks - Version 0.2 (obsolete)
=====================================================
...
:download:`csv <openEPDA_uPDK_SBB_v0.2.yaml.csv>` format. More information
...
:download:`yaml <openEPDA_uPDK_SBB_v0.2.yaml>`.
