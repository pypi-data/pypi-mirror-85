...
from typing import ByteString, Dict, List, MutableSequence, Sequence, Union
...
def evaluate_expression(
    expr: TNestedSequence, params=None
    ...
    if isinstance(expr, Real):
        ...
        res = openepda_parser.eval(expr, params=params)
        ...
        res = [evaluate_expression(e, params=params) for e in expr]
    elif isinstance(expr, tuple):
        res = tuple(evaluate_expression(e, params=params) for e in expr)
