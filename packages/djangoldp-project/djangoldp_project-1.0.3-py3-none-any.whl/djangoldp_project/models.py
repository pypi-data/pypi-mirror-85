...
def manage_deleted_project_owner(sender, instance, **kwargs):
    # was the owner removed?
    if instance.user is not None and instance.user == instance.project.owner:
        ...
        if alt.exists():
            instance.project.owner = alt[0].user
