...
class PSenseParser:
    def __init__(self, filename="", exp_config=None, debugmode=False):
        ...
        self.file_identifier = {
            ...
            "DEV-DL-SENSOR": "timestamp,id,v_batt,v_cr,enable_w1,discard_w1,i_w1,v_w1,enable_w2,discard_w2,i_w2,v_w2,enable_w3,discard_w3,i_w3,v_w3",
            "DEV-DL-AGGREG": "index,timestamp,type,event,id,v_batt,v_cr,enable_w1,discard_w1,i_w1,v_w1,enable_w2,discard_w2,i_w2,v_w2,enable_w3,discard_w3,i_w3,v_w3",
            "DEV-STREAM": "BWIIData,",
            "WEB-APP": "AppSettings",
