...
file_pool_dir = "./file_pool/"
# with open(rel2abs("./file_pool_path.txt"), "r", encoding = "utf-8") as f:
...
def tskr():
	...
	if len(argv_ls) == 2:
		...
		# tskr形式で保存
		file_acc = tskr_save(org_filename)
