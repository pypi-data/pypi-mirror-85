...
class ListJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/importexport.html#ImportExport.Paginator.ListJobs.paginate)
        """
