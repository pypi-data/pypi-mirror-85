...
FirestoreTuple = namedtuple("FirestoreTuple", ["id", "data"])
...
class EventTypes(Enum):
    ...
    CRAFT_RECORD_DELETED = "CRAFT_RECORD_DELETED"
    TASK_SCHEDULE_DATE_CHANGED = "TASK_SCHEDULE_DATE_CHANGED"
...
event_type_codes = {
    ...
    EventTypes.TASK_SCHEDULE_DATE_CHANGED: 96,
    EventTypes.TASK_DELETED: 98,
    EventTypes.CRAFT_RECORD_DELETED: 99,
}
...
class SiteKeyCompany(FirebaseDoc):
    ...
    schema: ClassVar[Dict] = {
        ...
        "isPlantCompany": {"type": "boolean", "required": False, "nullable": False},
        "mainPointOfContact": {
            "type": "string",
            "required": True,
            "maxlength": 200,
