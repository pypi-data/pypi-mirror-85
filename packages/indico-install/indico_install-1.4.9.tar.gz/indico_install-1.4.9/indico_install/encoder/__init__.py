...
@options_wrapper()
def encode(
    ctx, value=None, from_key=None, save_key=None, from_file=None, stdout=True, **kwargs
):
    """
...
@options_wrapper()
def decode(
    ctx, value=None, from_key=None, save_key=None, save_file=None, stdout=True, **kwargs
):
    """
