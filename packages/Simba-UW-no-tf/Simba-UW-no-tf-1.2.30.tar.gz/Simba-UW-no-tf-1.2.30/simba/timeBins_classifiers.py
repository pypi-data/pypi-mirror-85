...
def time_bins_classifier(inifile,binLength):
    ...
    if len(logList) > 0:
        ...
        logDf.to_csv(log_fn)
        print('WARNING: Some of the videos you attempted to analyze contains an unequal number of time-bins and was not appended to the final analysis output. To see which videos where omitted, check the logfile in project_folder/logs or the SimBA GitHub repository for more information')