...
class Parser:
    def __init__(self, model_type, model):
        self.model = model
        print(model_type)
        self.input_parser = self.INPUT_PARSER_MAPPING[model_type] if model_type in self.INPUT_PARSER_MAPPING else self.INPUT_PARSER_MAPPING['general']
        self.output_parser = self.OUTPUT_PARSER_MAPPING[model_type] if model_type in self.OUTPUT_PARSER_MAPPING else self.OUTPUT_PARSER_MAPPING['general']
