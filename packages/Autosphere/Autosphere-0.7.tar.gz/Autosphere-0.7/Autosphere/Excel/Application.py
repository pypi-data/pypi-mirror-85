...
class Application:
    ...
    def add_new_workbook(self) -> None:
        ...
        Example: 
            ...
            Add New Workbook     SalesData2.xlsx
    ...
    def set_active_worksheet(
        ...
        Example:
            ...
            Set Active Worksheet    sheetname=data
    ...
    def find_first_available_row(
        ...
        Example: 
            ...
            Find First Available Row    row=1 
            ...                         column=1
