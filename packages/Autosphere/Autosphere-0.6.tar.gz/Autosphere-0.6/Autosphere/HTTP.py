...
from Autosphere.core.notebook import notebook_file


class HTTP(RequestsLibrary):
    """Autosphere Framework HTTP library that extends functionality of RequestsLibrary,
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.fs = FileSystem()
        self.session_alias_prefix = "AutoSpheresession_alias."
