...
class Foreperson:
    ...
    def ready(self, directory):
        ...
        self.header = f' creator:\n   name:{self.creator['name']}\n'
                      f'   affiliation:{self.creator['affiliation']}\n'
                      f'   time:{self.creator['time']}\n data source:\n'
                      f'   experiment:\n     '
                      f'probe:{self.data_source['experiment']['probe']}\n     '
                      f'instrument:{self.data_source['experiment']['instrument']}\n     '
                      f'sample:{self.data_source['experiment']['sample']}\n '
                      f'reduction:\n   software:{self.reduction['software']}\n   '
                      f'yaml:{self.reduction['yaml']}\n data:\n   '
                      f'column 1:{self.data['column 1']}\n   '
                      f'column 2:{self.data['column 2']}\n   '
                      f'column 3:{self.data['column 3']}'
        if self.n_columns == 4:
