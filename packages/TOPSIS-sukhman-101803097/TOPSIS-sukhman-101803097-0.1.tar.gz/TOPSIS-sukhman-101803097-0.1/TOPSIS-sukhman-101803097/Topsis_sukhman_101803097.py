...
def main():
    ...
    if len(sys.argv) < 5:
        print('correct parameters not passed');
        sys.exit()
    ...
    try:
        ...
        print('Weights or Impacts are not seperated by commas ')
        sys.exit()
    ...
    try:
        ...
        print(' File selected by u not found');
        sys.exit()
        
    if len(list(input_data.columns))<=2:
        print('Input file should contain 3 or more columns ')
        sys.exit()
