...
class Config:
    ...
    def __init__(self, **kwargs):
        ...
        # TODO: figure out values for these constants, based on average upload
        # speed and our expected rate for inserting a prediction
        self.prediction_queue_batch_size = 4000
        self.prediction_queue_flush_interval = 5
        self.prediction_queue_max_predictions = 500000
