...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '3.1.0-alpha.1604936742+f68fac16'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 3.1.0-alpha.1604936742+f68fac16`
                """)
            else:
                raise
