    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_blue_green_container_deployment._jsii": [
            "cdk-blue-green-container-deployment@1.9.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_blue_green_container_deployment": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-ecr>=1.74.0, <2.0.0",
        "aws-cdk.aws-ecs>=1.74.0, <2.0.0",
        "aws-cdk.aws-elasticloadbalancingv2>=1.74.0, <2.0.0",
