...
_url_data =  {
                '1. An Introduction to reStructuredText' : 'http://docutils.sourceforge.net/docs/ref/rst/introduction.html',
                '2. A ReStructuredText Primer' : 'http://docutils.sourceforge.net/docs/user/rst/quickstart.html',
                '3. Quick reStructuredText' : 'http://docutils.sourceforge.net/docs/user/rst/quickref.html',
                '4. reStructuredText Markup Specification' : 'http://docutils.sourceforge.net/docs/ref/rst/restructuredtext.html',
...
'''
_url_data =  {
                '1. RestructuredText cheatsheet' : 'https://github.com/ralsina/rst-cheatsheet/blob/master/rst-cheatsheet.rst',
