...
class DescribeCasesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeCases.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.21/reference/services/support.html#Support.Paginator.DescribeCases.paginate)
        """
...
class DescribeCommunicationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeCommunications.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.21/reference/services/support.html#Support.Paginator.DescribeCommunications.paginate)
        """
