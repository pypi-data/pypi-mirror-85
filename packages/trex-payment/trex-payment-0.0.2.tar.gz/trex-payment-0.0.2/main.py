...
def create_app():
    ...
    templates_path      = os.path.join(base_dir, "templates_bak")
    ...
    with app.app_context():
        ...
        (data, database_config)                     = read_service_account_file(credential_filepath=credential_filepath)
        ...
        app.config['database_config']               = data
