...
APPLICATION_TITLE                           = 'Penefit Payment Gateway'
APPLICATION_DESC                            = 'Penefit payment gateway for penefit service payment'
...
SENDGRID_API_KEY                                    = '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'
