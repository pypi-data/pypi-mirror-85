...
[boto3.ApplicationDiscoveryService 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/discovery.html#ApplicationDiscoveryService) service
compatible with
