...
[boto3.ApplicationDiscoveryService 1.16.14](https://boto3.amazonaws.com/v1/documentation/api/1.16.14/reference/services/discovery.html#ApplicationDiscoveryService) service
compatible with
