...
class SearchDevicesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [SearchDevices.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/braket.html#Braket.Paginator.SearchDevices.paginate)
        """
...
class SearchQuantumTasksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [SearchQuantumTasks.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/braket.html#Braket.Paginator.SearchQuantumTasks.paginate)
        """
