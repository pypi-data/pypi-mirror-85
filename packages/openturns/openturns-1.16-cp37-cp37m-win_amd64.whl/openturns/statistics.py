...
class StationaryFunctionalCovarianceModel(StationaryCovarianceModel):
    r"""
    ...
    def computeStandardRepresentative(self, *args):
        ...
        :math:`\rho\left(\dfrac{\vect{\tau}}{\theta}\right)` if the model is stationary.
        """
        return _statistics.StationaryFunctionalCovarianceModel_computeStandardRepresentative(self, *args)
