...
class UserDefined(openturns.model_copula.DiscreteDistribution):
    ...
    points : 2-d sequence of float
        `List of `n` points of dimension `d` :math:`x_{ij}, i = 1, \ldots, n, j = 1, \ldots, d`.
    weights : sequence of float
    ...
    The sampling is done using the *alias* method as described in [devroye1986]_, Chapter 3. It has an optimal space complexity of :math:`\cO(n)` and runtime CPU complexity of :math:`\cO(1)`, see :meth:`~openturns.DistFunc_rDiscrete`.
