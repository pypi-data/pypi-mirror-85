...
class Base:
    ...
    pxButtons = Px('''
      ...
      <div if="isEdit and current.showSave" var2="label=_('object_save')">
       <div>
        <a class="clickable"
         ...
         <img src=":url('save.svg')" class=":picto"/><br/>
         <x>::label</x>
        </a>
       </div>
      </div>
      ...
      <div if="isEdit and current.showCancel" var2="label=_('object_cancel')">
       <div>
        <a class="clickable" name="cancel"
         ...
         <img src=":url('cancel.svg')" class=":picto"/><br/>
         <x>::label</x>
        </a>
       </div>
      </div>
      ...
      <div if="not isEdit and not popup and guard.mayDelete(o) and \
       ...
       <div>
        <a class="clickable" onclick=":'onDeleteObject(%s)' % q(o.url)">
         <img src=":url('delete.svg')" class=":picto"/><br/>
         <x>::label</x>
        </a>
       </div>
      </div>
     ...
     <x if="not isEdit"
        var2="fields=o.getFields('buttons', phase=phase.name);
              layout='view'">
