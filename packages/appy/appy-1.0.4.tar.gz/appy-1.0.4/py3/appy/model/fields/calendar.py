...
class Calendar(Field):
    ...
    view = cell = Px('''
     <div var="defaultDate=field.getDefaultDate(o);
               ...
               preComputed=field.getPreComputedInfo(o, monthDayOne, grid);
               mayEdit=guard.mayEdit(o, field.writePermission);
               objUrl=o.url;
    ...
    def __init__(self, eventTypes=None, eventNameMethod=None,
      ...
      legend=None, view=None, cell=None, edit=None, xml=None, translations=None,
      delete=True, beforeDelete=None, selectableMonths=6,
