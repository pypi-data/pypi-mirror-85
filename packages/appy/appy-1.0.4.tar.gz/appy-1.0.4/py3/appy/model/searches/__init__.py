     ...
     <div id=":mode.hook">
      ...
      <div if="not popup and search.showTitle" class="pageTitle topSpaceS">
       ...
       <x if="search.add and guard.mayInstantiate(class_)"
          var2="asButton=True; viaPopup=search.viaPopup;
...
class Search:
    ...
    def __init__(self, name=None, group=None, sortBy='title', sortOrder='asc',
                 ...
                 showPods=True, showTitle=True, showNav='both',
                 navAlign='right', translated=None, translatedDescr=None,
                 checkboxes=False, checkboxesDefault=True, container=None,
                 add=False, resultModes=None, shownInfo=None, actions=None,
                 rowAlign='top', pageLayoutOnView=None, **fields):
