...
class XhtmlPreprocessor:
    ...
    @classmethod
    def preprocess(class_, s, html=False, pre=True, code=False):
        ...
        # tags are converted to one-cell tables. If p_code is True, links to
        # external Python code files are replaced with the part of this file as
        # specified by the link's content.
        ...
        if code: s = PrettyPrinter.getFromXhtml(s)
...
class Xhtml2OdtConverter:
    ...
    def __init__(self, s, stylesManager, localStylesMapping, keepWithNext,
                 keepImagesRatio, imagesMaxWidth, renderer, html, code, unwrap):
        self.renderer = renderer
        self.xhtmlString = XhtmlPreprocessor.preprocess(s, html=html, code=code)
