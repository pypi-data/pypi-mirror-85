...
class ListAttacksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAttacks.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.18/reference/services/shield.html#Shield.Paginator.ListAttacks.paginate)
        """
...
class ListProtectionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListProtections.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.18/reference/services/shield.html#Shield.Paginator.ListProtections.paginate)
        """
