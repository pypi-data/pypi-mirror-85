        ...
        for idx, node in enumerate(nodes):
            ...
            for func in function_order:
                if func in target_funcs:
                    # If targets exist before the first source, they are skipped for now and will be connected to the
                    # last source in the function order later to create a feedback loop
                    if function_order.index(func) <= first_source_idx:
                        idx = 0
                    else:
            ...
            for target in target_funcs:
                if function_order.index(target) <= first_source_idx:
