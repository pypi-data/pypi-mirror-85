...
class ListSecretsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListSecrets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/secretsmanager.html#SecretsManager.Paginator.ListSecrets.paginate)
        """
