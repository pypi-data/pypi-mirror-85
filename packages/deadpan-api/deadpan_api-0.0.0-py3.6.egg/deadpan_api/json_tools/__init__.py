...
logger = logging.getLogger("DEADPAN_API_JSON")
...
def run_json(r, app): 
    ...
    #a PIL
        ...
        #for when the json is stored on a server
            ...
            text = variables_info
            logger.warning("WARNING - THIS METHOD OF PASSING DATA TO A PLUGIN IS DEPRECATED AND WILL BE REMOVED IN FUTURE VERSIONS OF deadpan_api. PLEASE SEE DOCUMENTATION.")
