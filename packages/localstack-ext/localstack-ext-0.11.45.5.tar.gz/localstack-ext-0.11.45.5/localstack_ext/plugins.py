...
def register_localstack_plugins():
 ...
 if VlPcg([is_api_enabled(api)for api in EXTERNAL_PORT_APIS]):
...
def load_plugin_files():
 try:
  ...
  if 'No module named' not in VlPcR(e):
   print(e)
...
def api_key_configured():
 return VlPcn(os.environ.get('LOCALSTACK_API_KEY'))
