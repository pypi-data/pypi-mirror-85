...
def register_localstack_plugins():
 ...
 if ExdlA([is_api_enabled(api)for api in EXTERNAL_PORT_APIS]):
...
def load_plugin_files():
 try:
  ...
  if 'No module named' not in ExdlT(e):
   print(e)
...
def api_key_configured():
 return Exdls(os.environ.get('LOCALSTACK_API_KEY'))
