...
class MTM(MT):
    ...
    def __init__(self, account_book_path: str, encoding="gbk", nrows=None, chunksize=1000000):
        super(MTM, self).__init__(
            account_book_path, encoding, nrows, chunksize)
        self.TRADES = [("贷款发放", 11400301, 13300700),
                       ("无资金流实还本金",13300700,11400301),
                       ("有资金流实还本金", 13311700, 11400301),
                       ("实还表内利息", 13311700, 13202003),
                       ("实还表内罚息", 13311700, 13210903),
                       ("计提表内利息", 13202003, 50080803),
                       ("计提表内罚息", 13210903, 50080803),
                       ("计提表外利息", 13202003, 13220903),
                       ("计提表外罚息", 13210903, 13220903),
                       ("利息转非应计", 50080803, 13220903),
                       ("罚息转非应计", 50080803, 13220903),
                       ("利息非应计转回", 13220903, 50080803),
                       ("罚息非应计转回", 13220903, 50080803)]
