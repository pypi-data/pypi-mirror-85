...
[boto3.MarketplaceMetering 1.16.14](https://boto3.amazonaws.com/v1/documentation/api/1.16.14/reference/services/meteringmarketplace.html#MarketplaceMetering) service
compatible with
