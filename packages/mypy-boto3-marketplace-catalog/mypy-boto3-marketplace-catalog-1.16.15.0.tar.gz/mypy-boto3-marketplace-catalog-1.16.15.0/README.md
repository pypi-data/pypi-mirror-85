...
[boto3.MarketplaceCatalog 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/marketplace-catalog.html#MarketplaceCatalog) service
compatible with
