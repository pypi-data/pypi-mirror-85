...
class ListServersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListServers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.21/reference/services/transfer.html#Transfer.Paginator.ListServers.paginate)
        """
