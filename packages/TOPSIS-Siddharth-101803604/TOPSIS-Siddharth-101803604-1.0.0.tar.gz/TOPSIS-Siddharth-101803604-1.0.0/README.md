...
Submitted by: Siddharth Agarwal
...
The package TOPSIS-Siddharth-101803604 can be run though the command line as follows:
```
>> pip install TOPSIS-Siddharth-101803604==0.3.0
```
```
>> python
