    ...
    def search(
        ...
        Args:
            ...
            initialize (dict, optional): 
                [description]. Defaults to {"grid": 8, "random": 4, "vertices": 8}.
            warm_start ([type], optional): 
                [description]. Defaults to None.
            max_time ([type], optional): 
                [description]. Defaults to None.
            max_score ([type], optional): 
                [description]. Defaults to None.
            memory (bool, optional): 
                [description]. Defaults to True.
            memory_warm_start ([type], optional): 
                [description]. Defaults to None.
            verbosity (dict, optional): 
                [description]. Defaults to { "progress_bar": True, "print_results": True, "print_times": True, }.
