...
try:
    ...
    from pulsestreamer.grpc.pulse_streamer_pb2 import VoidMessage, PulseMessage, SequenceMessage, ClockMessage, DrpClkSetMessage, TriggerMessage, SetNetworkMessage, EnableStaticIPMessage, HostnameMessage, PulseStreamerStub, SetSquareWaveMessage, AnalogCalibrationData, SupplyStatusData
