...
def zencode_exec_tobuf(script: 'char *', conf: 'char *', keys: 'char *', data: 'char *', stdout_buf: 'char *', stderr_buf: 'char *') -> "int":
    return _zenroom.zencode_exec_tobuf(script, conf, keys, data, stdout_buf, stderr_buf)
zencode_exec_tobuf = _zenroom.zencode_exec_tobuf

def zenroom_exec_tobuf(script: 'char *', conf: 'char *', keys: 'char *', data: 'char *', stdout_buf: 'char *', stderr_buf: 'char *') -> "int":
    return _zenroom.zenroom_exec_tobuf(script, conf, keys, data, stdout_buf, stderr_buf)
