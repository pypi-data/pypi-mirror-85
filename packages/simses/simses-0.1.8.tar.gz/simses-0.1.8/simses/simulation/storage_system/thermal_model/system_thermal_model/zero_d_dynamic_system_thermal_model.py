...
class ZeroDDynamicSystemThermalModel(SystemThermalModel):
    ...
    def __init__(self, ambient_thermal_model: AmbientThermalModel, housing: Housing,
        ...
        self.__l1_temperature = self.__housing.surface_temperature_L1  # K
        self.__l2_temperature = self.__housing.temperature_L2  # K
        self.__l3_temperature = self.__housing.surface_temperature_L3  # K
