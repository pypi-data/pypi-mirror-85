...
class FortyFtContainer(Housing):
    ...
    def __init__(self, ambient_thermal_model: AmbientThermalModel):
        ...
        # Done - TODO (PL) Add corresponding values for 40 ft. Container
        # Container external dimensions (from mtcontainer)
        self.outer_length = 12.192  # m
        self.outer_breadth = 2.438  # m
        self.outer_height = 2.896  # m
        ...
        self.thickness_L2 = 0.050  # m, L2 = Layer 2 - Rock wool
        ...
        self.__density_L2_material = 100  # kg/m3 (for Rock wool)
