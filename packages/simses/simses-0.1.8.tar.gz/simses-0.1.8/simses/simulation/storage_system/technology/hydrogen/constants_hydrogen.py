...
class ConstantsHydrogen:
    ...
    HYDROGEN_ISENTROP_EXPONENT = 1.4098  # # from: "Wasserstoff in der Fahrzeugtechnik" under normal conditions: p = 1 bar, T = 0°C
    HYDROGEN_REAL_GAS_FACTOR = 1.0006  # from: "Wasserstoff in der Fahrzeugtechnik" under normal conditions: p = 1 bar, T = 0°C
    HYDROGEN_HEAT_CAPACITY = 14304  # J/(kg K)
    HYDROGEN_NORM_QUBIC_M = 11.1235  # Nm³/kg
