...
def calculate_anode_activation_current(activation_overvoltage: float, temperature: float) -> float:
    ...
    factor = (2 * ConstantsHydrogen.FARADAY_CONST * activation_overvoltage) / (
                ConstantsHydrogen.IDEAL_GAS_CONST * temperature)
...
def display_example(temperature: float, compare: bool):
    ...
    if compare:
        ...
        activation_curve_path = 'UICurves\\ActivationOverpotentialAlkaline\\'
