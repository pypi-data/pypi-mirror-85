...
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.stack_model.alkaline_electrolyzer_model.alkaline_electrical_model import \
    AlkalineElectricalModel
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.stack_model.alkaline_electrolyzer_model.alkaline_pressure_model \
    import AlkalinePressureModel
from simses.simulation.storage_system.technology.hydrogen.electrolyzer.stack_model.alkaline_electrolyzer_model.alkaline_fluid_model \
    import AlkalineFluidModel
...
class AlkalineElectrolyzer(ElectrolyzerStackModel):
    ...
    def __init__(self, electrolyzer_maximal_power: float, electrolyzer_data_config: ElectrolyzerDataConfig):
        ...
        self.__electrical_model: AlkalineElectricalModel = AlkalineElectricalModel(self.__pressure_model, self.__fluid_model, electrolyzer_data_config,
                                                                                   self.__parameters)
