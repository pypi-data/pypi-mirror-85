...
class StackModule(ABC):
    ...
    def get_absolute_max_current(self) -> float:
        """
        Determines the maximal current of the stack module.
    ...
    def get_name(self) -> str:
        """
        Determines the class name of a stack typ  (e. g. CellDataStack5600W).
