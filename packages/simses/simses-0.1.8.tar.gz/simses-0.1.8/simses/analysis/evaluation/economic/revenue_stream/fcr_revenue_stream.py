...
class FCRRevenue(RevenueStream):
    ...
    def __init__(self, energy_management_data: EnergyManagementData, system_data: SystemData,
                 economic_analysis_config: EconomicAnalysisConfig, market: FcrMarketProfile,
        ...
        self.__fcr_price_profile: FcrMarketProfile = market
        
        self.__use_time_series = economic_analysis_config.fcr_use_price_timeseries
        if not self.__use_time_series:
            self.__fixed_fcr_price = economic_analysis_config.fcr_price
