...
class HydrogenTechnicalEvaluation(TechnicalEvaluation):
    ...
    def degradation_plotting(self):
        ...
        yaxis.append(Axis(data=data.resistance_increase_cyclic_el, label=HydrogenState.RESISTANCE_INCREASE_CYCLIC_EL, color=PlotlyPlotting.Color.BLUE))
        yaxis.append(Axis(data=data.resistance_increase_calendar_el, label=HydrogenState.RESISTANCE_INCREASE_CALENDAR_EL, color=PlotlyPlotting.Color.MAGENTA))
