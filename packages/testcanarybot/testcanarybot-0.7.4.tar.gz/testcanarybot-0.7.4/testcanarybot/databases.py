        ...
        if check == list:
            for name in names:
                if self.check(name[0]):
                    ...
                    self.__dbs[name[0]] = Database(os.getcwd() + '\\assets\\' + name[1])
            ...
            if self.check(names[0]):
                ...
                self.__dbs[names[0]] = Database(os.getcwd() + '\\assets\\' + names[1])
            ...
            if self.check(names):
                ...
                self.__dbs[names] = Database(os.getcwd() + '\\assets\\' + names)
