...
_MODELBUILDID = _descriptor.Descriptor(
  name='ModelBuildId',
  full_name='api.ModelBuildId',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='api.ModelBuildId.value', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ModelBuildId'] = _MODELBUILDID
...
ModelBuildId = _reflection.GeneratedProtocolMessageType('ModelBuildId', (_message.Message,), {
  'DESCRIPTOR' : _MODELBUILDID,
  '__module__' : 'api.ids_pb2'
  # @@protoc_insertion_point(class_scope:api.ModelBuildId)
  })
_sym_db.RegisterMessage(ModelBuildId)
