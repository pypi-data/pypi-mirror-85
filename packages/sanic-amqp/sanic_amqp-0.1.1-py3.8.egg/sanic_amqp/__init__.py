...
class PersistentAmqpPublisher(object):
    ...
    async def publish(self, message, *args, **kwargs):
        raise NotImplementedError('`publish(message, *args, **kwargs)` method must be implemented.')
...
class AmqpExtension(BaseExtension):
    ...
    def register_persistent_publisher(self, publisher_name: str, publisher: PersistentAmqpPublisher):
        self.persistent_publishers[publisher_name] = publisher
