...
class ListAccountRolesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAccountRoles.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/sso.html#SSO.Paginator.ListAccountRoles.paginate)
        """
...
class ListAccountsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAccounts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/sso.html#SSO.Paginator.ListAccounts.paginate)
        """
