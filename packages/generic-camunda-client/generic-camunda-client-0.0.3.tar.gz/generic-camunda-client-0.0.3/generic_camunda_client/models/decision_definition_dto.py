...
class DecisionDefinitionDto(object):
    ...
    def history_time_to_live(self):
        ...
        History time to live value of the decision definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.14/user-guide/process-engine/history/#history-cleanup).  # noqa: E501
