...
# Ensure logging directory exists before using it
lcmap_tap.mkdirs(lcmap_tap.home())
file_handler = logging.FileHandler(
    os.path.join(lcmap_tap.home(), "lcmap_tap_{}.log".format(get_time()))
)
...
class QtHandler(logging.Handler):
    """
    Custom handler for Qt widgets to display logging messages.
    """
