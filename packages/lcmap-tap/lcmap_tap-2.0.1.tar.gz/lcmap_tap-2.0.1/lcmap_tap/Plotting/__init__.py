"""
Initialize common data structures for the Plotting modules.
"""
COLORS = {
    "Developed": (1.0, 0.19607843137254902, 0.19607843137254902),
...
LEG_DEFAULTS = {
    ...
    "end_lines": {"color": "red", "linewidth": 2, "label": "End Date"},
    "break_lines": {
        "color": "orange",
        "linewidth": 2,
        "linestyle": "--",
    ...
    "start_lines": {"color": "green", "linewidth": 2, "label": "Start Date"},
    "model_lines": {"color": "black", "linewidth": 3, "label": "Model Fit"},
...
LINES = ["End Date", "Break Date", "Start Date", "Model Fit", "Datelines"]

VLINES = ["End Date", "Break Date", "Start Date"]
