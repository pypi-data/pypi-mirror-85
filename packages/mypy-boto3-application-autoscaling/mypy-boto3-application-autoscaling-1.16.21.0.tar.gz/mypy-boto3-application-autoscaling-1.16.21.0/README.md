...
[boto3.ApplicationAutoScaling 1.16.21](https://boto3.amazonaws.com/v1/documentation/api/1.16.21/reference/services/application-autoscaling.html#ApplicationAutoScaling) service
compatible with
