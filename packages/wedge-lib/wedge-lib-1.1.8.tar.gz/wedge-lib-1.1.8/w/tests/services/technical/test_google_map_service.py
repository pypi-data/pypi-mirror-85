...
class TestGMapService(TestCaseMixin):
    ...
    def test_get_place_detail(self):
        ...
        assert resp == {
            "formatted_address": "Ground floor, 48 Pirrama Rd, Pyrmont NSW 2009, "
            "Australia",
            "geometry": {
                "location": {"lat": -33.866489, "lng": 151.1958561},
                "viewport": {
                    "northeast": {"lat": -33.8655159697085, "lng": 151.1971010802915},
                    "southwest": {"lat": -33.8682139302915, "lng": 151.1944031197085},
                },
            },
