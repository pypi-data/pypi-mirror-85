...
# Form implementation generated from reading ui file 'guardata/client/gui/forms/main_window.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/logos/images/icons/guardata.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
