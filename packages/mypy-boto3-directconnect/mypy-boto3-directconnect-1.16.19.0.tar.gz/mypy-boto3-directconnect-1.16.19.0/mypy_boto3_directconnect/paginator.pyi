...
class DescribeDirectConnectGatewayAssociationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeDirectConnectGatewayAssociations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/directconnect.html#DirectConnect.Paginator.DescribeDirectConnectGatewayAssociations.paginate)
        """
...
class DescribeDirectConnectGatewayAttachmentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeDirectConnectGatewayAttachments.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/directconnect.html#DirectConnect.Paginator.DescribeDirectConnectGatewayAttachments.paginate)
        """
...
class DescribeDirectConnectGatewaysPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeDirectConnectGateways.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/directconnect.html#DirectConnect.Paginator.DescribeDirectConnectGateways.paginate)
        """
