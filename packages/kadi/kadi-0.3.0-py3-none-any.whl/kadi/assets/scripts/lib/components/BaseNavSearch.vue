  ...
  <div class="dropdown" ref="dropdown">
    <div class="input-group input-group-sm reponsive-width" data-toggle="dropdown">
      <input id="input"
             ...
             :placeholder="i18n.t('misc.quickSearch')"
             v-model="query"
             ref="input">
      <div class="input-group-append" v-if="query">
        <button id="clear-btn" type="button" class="btn btn-sm input-group-append-content" @click.stop="clearQuery">
          <i class="fas fa-times"></i>
        </button>
      </div>
      <div class="input-group-append" v-else>
        <span id="search-btn" class="input-group-text input-group-append-content">
