...
[boto3.CodeGuruReviewer 1.16.21](https://boto3.amazonaws.com/v1/documentation/api/1.16.21/reference/services/codeguru-reviewer.html#CodeGuruReviewer) service
compatible with
