...
[boto3.SageMakerRuntime 1.16.15](https://boto3.amazonaws.com/v1/documentation/api/1.16.15/reference/services/sagemaker-runtime.html#SageMakerRuntime) service
compatible with
