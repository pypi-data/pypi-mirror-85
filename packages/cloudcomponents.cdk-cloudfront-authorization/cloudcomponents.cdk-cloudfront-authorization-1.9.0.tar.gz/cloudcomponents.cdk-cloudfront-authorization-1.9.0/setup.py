    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_cloudfront_authorization._jsii": [
            "cdk-cloudfront-authorization@1.9.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_cloudfront_authorization": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cognito>=1.73.0, <2.0.0",
        ...
        "cloudcomponents.cdk-deletable-bucket>=1.8.0, <2.0.0",
        "cloudcomponents.cdk-lambda-at-edge-pattern>=1.8.0, <2.0.0",
