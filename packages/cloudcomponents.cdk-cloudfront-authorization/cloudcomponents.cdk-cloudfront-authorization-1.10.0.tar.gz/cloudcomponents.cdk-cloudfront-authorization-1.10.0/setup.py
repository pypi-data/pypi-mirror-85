    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_cloudfront_authorization._jsii": [
            "cdk-cloudfront-authorization@1.10.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_cloudfront_authorization": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-certificatemanager>=1.74.0, <2.0.0",
        "aws-cdk.aws-cloudfront-origins>=1.74.0, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.74.0, <2.0.0",
        "aws-cdk.aws-cognito>=1.74.0, <2.0.0",
        ...
        "cloudcomponents.cdk-deletable-bucket>=1.9.0, <2.0.0",
        "cloudcomponents.cdk-lambda-at-edge-pattern>=1.9.0, <2.0.0",
