...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '4.4.0-alpha.1605732988+f5b3eb92'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 4.4.0-alpha.1605732988+f5b3eb92`
                """)
            else:
                raise
