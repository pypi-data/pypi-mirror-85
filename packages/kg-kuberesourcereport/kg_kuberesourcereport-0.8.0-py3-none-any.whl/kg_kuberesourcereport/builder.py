...
class KubeResourceReportBuilder(Builder):
    """
    Kube Resource Report builder.

    Based on `codeberg.org/hjacobs/kube-resource-report <https://codeberg.org/hjacobs/kube-resource-report>`_.
                    ...
                    'template': {
                        ...
                        'spec': {
                            ...
                            'containers': [{
                                ...
                                'image': self.option_get('container.kube-resource-report'),
                            ...
                            {
                                'name': 'nginx',
                                'image': self.option_get('container.nginx'),
                                'volumeMounts': [{
                                ...
                                'resources': ValueData(value=self.option_get('kubernetes.resources.deployment-nginx'),
                                                       disabled_if_none=True),
