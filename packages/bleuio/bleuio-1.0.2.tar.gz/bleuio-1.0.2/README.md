...
```shell
pip install /path_to_directory/bleuio_lib-0.0.1-py3-none-any.whl
```
...
my_dongle = BleuIo('COM7')
# Specific COM port (Linux) 'dev/tty.xxxxx...'
my_dongle = BleuIo('/dev/tty.123546877')
# Specific COM port (Mac) 'dev/cu.xxxx...'
my_dongle = BleuIo('/dev/cu.123546877')
```
