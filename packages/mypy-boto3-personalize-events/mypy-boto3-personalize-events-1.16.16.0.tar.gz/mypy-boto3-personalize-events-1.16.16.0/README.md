...
[boto3.PersonalizeEvents 1.16.16](https://boto3.amazonaws.com/v1/documentation/api/1.16.16/reference/services/personalize-events.html#PersonalizeEvents) service
compatible with
