    ...
    def validate_pipeline(self):
        ...
        try:
            ...
            raise PipelineException(Messages.PIPELINE_INVALID,
                                    reference_code=ReferenceCodes._FORECASTING_PIPELINE_INVALID_VALUE) from val_error
        except TypeError as type_error:
            raise PipelineException(Messages.PIPELINE_INVALID,
                                    reference_code=ReferenceCodes._FORECASTING_PIPELINE_INVALID_TYPE) from type_error
