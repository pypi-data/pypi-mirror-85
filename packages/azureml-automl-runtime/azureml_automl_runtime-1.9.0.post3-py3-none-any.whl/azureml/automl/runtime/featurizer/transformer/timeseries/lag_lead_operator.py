            ...
            if np.issubdtype(type(v), np.signedinteger):
                ...
                if len(v) == 0:
                    raise ConfigException(
                        "The lags for all columns are represented by empty lists. "
                        "Please set target_lags parameter to None to "
                        "turn off the lag feature and run the experiment again.",
                        has_pii=False,
