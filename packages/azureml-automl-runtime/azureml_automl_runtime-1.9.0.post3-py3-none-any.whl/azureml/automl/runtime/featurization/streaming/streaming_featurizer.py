...
from azureml.automl.core.shared.exceptions import (
    AutoMLException, ClientException, DataException, InvalidDataTypeException, InvalidValueException,
    ...
    def _validate_inputs(self):
        if not isinstance(self._training_data, Dataflow):
            raise InvalidDataTypeException(
                "Preprocessing for large data is only allowed on Dataflows, instead got training "
        ...
        if not self._label_column:
            ...
            raise InvalidValueException(msg.format(self._label_column)).with_generic_msg(msg.format('[Masked]'))
