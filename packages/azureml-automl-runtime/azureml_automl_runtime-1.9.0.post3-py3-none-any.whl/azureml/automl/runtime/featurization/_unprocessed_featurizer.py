...
class BaseFeaturizer(ABC):
    ...
    def fit(self,
        ...
        if data_transformer is None or df is None:
            if data_transformer is None:
                logger.error("Cannot fit featurizer using null DataTransformer.")
            if df is None:
                logger.error("Cannot fit featurizer without input data.")
            raise InvalidArgumentException("Non-optional fit argument cannot be None.", has_pii=False)
