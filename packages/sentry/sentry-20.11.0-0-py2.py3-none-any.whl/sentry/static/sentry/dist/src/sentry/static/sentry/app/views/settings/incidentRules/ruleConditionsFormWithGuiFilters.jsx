...
var RuleConditionsFormWithGuiFilters = /** @class */ (function (_super) {
    ...
    RuleConditionsFormWithGuiFilters.prototype.render = function () {
        ...
        var selectLabel = function (label) { return ({
            ':before': {
                content: "\"" + label + "\"",
                color: theme.gray300,
                fontWeight: 600,
        ...
        <PanelBody>
          <List symbol="colored-numeric">
            ...
            singleValue: function (base) { return (__assign(__assign(__assign({}, base), selectLabel(t('Env: '))), { '.all-environment-note': { display: 'none' } })); },
            placeholder: function (base) { return (__assign(__assign({}, base), selectLabel(t('Env: ')))); },
        ...
        }} choices={environmentList} isDisabled={disabled || this.state.environments === null} isClearable inline={false} flexibleControlStateSize/>
            ...
            return (<SelectControl value={mappedValue} styles={{
                singleValue: function (base) { return (__assign(__assign({}, base), selectLabel(t('Data Source: ')))); },
                placeholder: function (base) { return (__assign(__assign({}, base), selectLabel(t('Data Source: ')))); },
