...
var StacktraceInterface = /** @class */ (function (_super) {
    ...
    StacktraceInterface.prototype.render = function () {
        ...
        return (<EventDataSection type={type} title={<CrashTitle title={t('Stacktrace')} hideGuide={hideGuide} newestFirst={newestFirst} onChange={this.handleChangeNewestFirst}/>} actions={<CrashActions stackView={stackView} platform={event.platform} stacktrace={data} onChange={this.handleChangeStackView}/>} wrapTitle={false}>
