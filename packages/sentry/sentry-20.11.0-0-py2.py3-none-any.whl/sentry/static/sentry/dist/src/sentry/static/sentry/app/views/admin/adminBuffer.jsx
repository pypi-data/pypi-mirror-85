...
var AdminBuffer = function () {
    ...
    return (<div>
      ...
      <div className="box">
        ...
        <InternalStatChart since={since} resolution="1hr" stat="jobs.finished.sentry.tasks.process_buffer.process_incr" label="Jobs"/>
      </div>
      ...
      <div className="box">
        ...
        <InternalStatChart since={since} resolution="1hr" stat="buffer.revoked" label="Jobs"/>
      </div>
    </div>);
};
