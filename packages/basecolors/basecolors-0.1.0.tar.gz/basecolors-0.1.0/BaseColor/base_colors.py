...
from BaseColor.win_color import printRed, printGreen, printYellow, printBlue, printPink, printSkyBlue
...
def red(txt, with_bgc=None):
    ...
    if platform.system() == "Linux":
        print(color(txt, "default", with_bgc or "ordinary", "red"))
    else:
        printRed(txt)
...
def green(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "default", with_bgc or "ordinary", "green"))
    else:
        printGreen(txt)
...
def yellow(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "default", with_bgc or "ordinary", "yellow"))
    else:
        printYellow(txt)
...
def blue(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "default", with_bgc or "ordinary", "blue"))
    else:
        printBlue(txt)
...
def magenta(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "default", with_bgc or "ordinary", "magenta"))
    else:
        printPink(txt)
...
def cyan(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "default", with_bgc or "ordinary", "cyan"))
    else:
        printSkyBlue(txt)
...
def hcyan(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "highlight", with_bgc or "ordinary", "cyan"))
    else:
        printSkyBlue(txt)
...
def hblue(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "highlight", with_bgc or "ordinary", "blue"))
    else:
        printBlue(txt)
...
def hmagenta(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "highlight", with_bgc or "ordinary", "magenta"))
    else:
        printPink(txt)
...
def hyellow(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "highlight", with_bgc or "ordinary", "yellow"))
    else:
        printYellow(txt)
...
def hgreen(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "highlight", with_bgc or "ordinary", "green"))
    else:
        printGreen(txt)
...
def hred(txt, with_bgc=None):
    ...
    """
    if platform.system() == "Linux":
        print(color(txt, "highlight", with_bgc or "ordinary", "red"))
    else:
        printRed(txt)
