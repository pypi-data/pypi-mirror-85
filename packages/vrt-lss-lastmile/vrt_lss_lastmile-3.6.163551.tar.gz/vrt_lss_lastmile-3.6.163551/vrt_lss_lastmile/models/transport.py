...
class Transport(object):
    ...
    def __init__(self, key=None, transport_type=None, transport_features=None, performer_restrictions=None, boxes=None, attributes=[], local_vars_configuration=None):  # noqa: E501
