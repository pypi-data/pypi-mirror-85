...
class ListEndpointsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListEndpoints.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.18/reference/services/s3outposts.html#S3Outposts.Paginator.ListEndpoints.paginate)
        """
