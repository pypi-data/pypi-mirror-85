...
class ListContainersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListContainers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.18/reference/services/mediastore.html#MediaStore.Paginator.ListContainers.paginate)
        """
