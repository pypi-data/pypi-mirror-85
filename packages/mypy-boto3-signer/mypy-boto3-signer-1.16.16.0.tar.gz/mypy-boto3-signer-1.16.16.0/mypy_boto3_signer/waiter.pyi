...
class SuccessfulSigningJobWaiter(Boto3Waiter):
    ...
    def wait(self, jobId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [SuccessfulSigningJob.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.16/reference/services/signer.html#Signer.Waiter.SuccessfulSigningJob.wait)
        """
