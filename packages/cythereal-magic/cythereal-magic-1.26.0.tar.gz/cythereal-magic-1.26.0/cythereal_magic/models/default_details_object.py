...
class DefaultDetailsObject(object):
    ...
    def __init__(self, detail_type=None):  # noqa: E501
        """DefaultDetailsObject - a model defined in Swagger"""  # noqa: E501
    ...
    def detail_type(self):
        """Gets the detail_type of this DefaultDetailsObject.  # noqa: E501

        The type of details being returned, or null if there  are no additional details for the given file.   # noqa: E501

        :return: The detail_type of this DefaultDetailsObject.  # noqa: E501
        :rtype: str
        """
    ...
    def detail_type(self, detail_type):
        """Sets the detail_type of this DefaultDetailsObject.

        The type of details being returned, or null if there  are no additional details for the given file.   # noqa: E501

        :param detail_type: The detail_type of this DefaultDetailsObject.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DefaultDetailsObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DefaultDetailsObject):
            return False
