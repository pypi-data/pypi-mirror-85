...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, repository_version=None, base_path=None, content_guard=None, name=None, pulp_created=None, repository=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
