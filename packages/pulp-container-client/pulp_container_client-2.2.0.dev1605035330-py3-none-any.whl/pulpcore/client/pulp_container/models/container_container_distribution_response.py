...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, pulp_href=None, content_guard=None, repository_version=None, name=None, repository=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
