...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, name=None, repository=None, pulp_href=None, content_guard=None, pulp_created=None, repository_version=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
