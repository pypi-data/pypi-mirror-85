...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, content_guard=None, repository=None, repository_version=None, base_path=None, name=None, pulp_href=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
