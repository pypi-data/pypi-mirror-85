...
parser.add_argument("--ase",
        ...
        type=str,
        required=True,
        help='Population level ASE loci RNA reads file run by aseFilter')
...
parser.add_argument("--hetNumber",
        ...
        default='10',
        required=True,
        help='The least heterozygous locus number to run aseQTL')
...
parser.add_argument("--cisRegion",
        ...
        required=True,
        default='100000',
        help='Define the candidate regultory SNP distance from ASE locus ')
