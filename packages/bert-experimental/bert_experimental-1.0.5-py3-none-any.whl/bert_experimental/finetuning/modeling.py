...
def build_bert_module_fn(config_path, vocab_path, seq_layer, tok_layer, do_lower_case):
...
def build_bert_module(config_path, vocab_path, ckpt_path, out_path, 
    ...
    module_fn = build_bert_module_fn(config_path, vocab_path, 
                                     seq_layer=seq_layer, tok_layer=tok_layer, do_lower_case=do_lower_case)
