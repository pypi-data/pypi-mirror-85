...
class DocumentTypes(DocumentTypesBase):
    """
    This enum contains the URIs for the MMIF document types defined in the spec version 0.2.1.
    ...
    """
    Document = 'http://mmif.clams.ai/0.2.1/vocabulary/Document'
    VideoDocument = 'http://mmif.clams.ai/0.2.1/vocabulary/VideoDocument'
    AudioDocument = 'http://mmif.clams.ai/0.2.1/vocabulary/AudioDocument'
    ImageDocument = 'http://mmif.clams.ai/0.2.1/vocabulary/ImageDocument'
    TextDocument = 'http://mmif.clams.ai/0.2.1/vocabulary/TextDocument'
