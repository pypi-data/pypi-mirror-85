...
Update compiled rules and the readme with `./pre-release.py readme`. When finished, fix the generated `README.rst` until Pandoc learns how to translate Markdown with images that are links into reStructuredText:
