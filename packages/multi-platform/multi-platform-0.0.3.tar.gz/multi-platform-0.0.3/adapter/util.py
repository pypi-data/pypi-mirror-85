...
def inflate(self,name):
    ...
    dirname = os.getcwd()
    logger.info('multi-platform >>> current path : %s' % dirname)
    while os.path.basename(dirname) != "testcase":
        dirname = os.path.dirname(dirname)

    path = os.path.join(os.path.join(os.path.abspath(os.path.dirname(dirname)), "panel"), name)
