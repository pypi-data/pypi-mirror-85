...
class CallProcessingApi(object):
    ...
    def send_process_audio(self, cid, file, customer_id, agent_id, channels, calldirection, **kwargs):  # noqa: E501
        """send_process_audio  # noqa: E501

        Sends a new request with audio file upload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_process_audio(cid, file, customer_id, agent_id, channels, calldirection, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.send_process_audio_with_http_info(cid, file, customer_id, agent_id, channels, calldirection, **kwargs)  # noqa: E501
        else:
            (data) = self.send_process_audio_with_http_info(cid, file, customer_id, agent_id, channels, calldirection, **kwargs)  # noqa: E501
            return data

    def send_process_audio_with_http_info(self, cid, file, customer_id, agent_id, channels, calldirection, **kwargs):  # noqa: E501
        """send_process_audio  # noqa: E501

        Sends a new request with audio file upload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_process_audio_with_http_info(cid, file, customer_id, agent_id, channels, calldirection, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cid', 'file', 'customer_id', 'agent_id', 'channels', 'calldirection', 'name', 'customer_ind', 'agent_team', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'storedata', 'tag', 'meta', 'predictionmode', 'tasks', 'success']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
