...
def main():
    ...
    # if File extension is not csv
        ...
        # if there are less then 3 columns in input dataset
        if nCol < 3:
            print("ERROR : Input file have less then 3 columns")
            exit(1)

        # for Handling errors of weighted and impact arrays
        try:
        ...
        # for Handeling non-numeric value
...
def Cal_Values(temp_dataset, nCol, impact):
