...
int _cffi_f_zmq_proxy_steerable(void * x0, void * x1, void * x2, void * x3)
{
...
int _cffi_const_ZMQ_BINDTODEVICE(long long *out_value)
{
  *out_value = (long long)(ZMQ_BINDTODEVICE);
  return (ZMQ_BINDTODEVICE) <= 0;
}
...
int _cffi_const_ZMQ_CONNECT_ROUTING_ID(long long *out_value)
{
  *out_value = (long long)(ZMQ_CONNECT_ROUTING_ID);
  return (ZMQ_CONNECT_ROUTING_ID) <= 0;
}
...
int _cffi_const_ZMQ_EVENT_HANDSHAKE_FAILED_AUTH(long long *out_value)
{
  *out_value = (long long)(ZMQ_EVENT_HANDSHAKE_FAILED_AUTH);
  return (ZMQ_EVENT_HANDSHAKE_FAILED_AUTH) <= 0;
}

int _cffi_const_ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL(long long *out_value)
{
  *out_value = (long long)(ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL);
  return (ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL) <= 0;
}

int _cffi_const_ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL(long long *out_value)
{
  *out_value = (long long)(ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL);
  return (ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL) <= 0;
}

int _cffi_const_ZMQ_EVENT_HANDSHAKE_SUCCEEDED(long long *out_value)
{
  *out_value = (long long)(ZMQ_EVENT_HANDSHAKE_SUCCEEDED);
  return (ZMQ_EVENT_HANDSHAKE_SUCCEEDED) <= 0;
}
...
int _cffi_const_ZMQ_GSSAPI_NT_HOSTBASED(long long *out_value)
{
  *out_value = (long long)(ZMQ_GSSAPI_NT_HOSTBASED);
  return (ZMQ_GSSAPI_NT_HOSTBASED) <= 0;
}

int _cffi_const_ZMQ_GSSAPI_NT_KRB5_PRINCIPAL(long long *out_value)
{
  *out_value = (long long)(ZMQ_GSSAPI_NT_KRB5_PRINCIPAL);
  return (ZMQ_GSSAPI_NT_KRB5_PRINCIPAL) <= 0;
}

int _cffi_const_ZMQ_GSSAPI_NT_USER_NAME(long long *out_value)
{
  *out_value = (long long)(ZMQ_GSSAPI_NT_USER_NAME);
  return (ZMQ_GSSAPI_NT_USER_NAME) <= 0;
}
...
int _cffi_const_ZMQ_GSSAPI_PRINCIPAL_NAMETYPE(long long *out_value)
{
  *out_value = (long long)(ZMQ_GSSAPI_PRINCIPAL_NAMETYPE);
  return (ZMQ_GSSAPI_PRINCIPAL_NAMETYPE) <= 0;
}
...
int _cffi_const_ZMQ_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE(long long *out_value)
{
  *out_value = (long long)(ZMQ_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE);
  return (ZMQ_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE) <= 0;
}
...
int _cffi_const_ZMQ_MSG_T_SIZE(long long *out_value)
{
  *out_value = (long long)(ZMQ_MSG_T_SIZE);
  return (ZMQ_MSG_T_SIZE) <= 0;
}
...
int _cffi_const_ZMQ_MULTICAST_LOOP(long long *out_value)
{
  *out_value = (long long)(ZMQ_MULTICAST_LOOP);
  return (ZMQ_MULTICAST_LOOP) <= 0;
}
...
int _cffi_const_ZMQ_NOTIFY_CONNECT(long long *out_value)
{
  *out_value = (long long)(ZMQ_NOTIFY_CONNECT);
  return (ZMQ_NOTIFY_CONNECT) <= 0;
}

int _cffi_const_ZMQ_NOTIFY_DISCONNECT(long long *out_value)
{
  *out_value = (long long)(ZMQ_NOTIFY_DISCONNECT);
  return (ZMQ_NOTIFY_DISCONNECT) <= 0;
}
...
int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_BAD_REQUEST_ID(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZAP_BAD_REQUEST_ID);
  return (ZMQ_PROTOCOL_ERROR_ZAP_BAD_REQUEST_ID) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_BAD_VERSION(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZAP_BAD_VERSION);
  return (ZMQ_PROTOCOL_ERROR_ZAP_BAD_VERSION) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_INVALID_METADATA(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZAP_INVALID_METADATA);
  return (ZMQ_PROTOCOL_ERROR_ZAP_INVALID_METADATA) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_INVALID_STATUS_CODE(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZAP_INVALID_STATUS_CODE);
  return (ZMQ_PROTOCOL_ERROR_ZAP_INVALID_STATUS_CODE) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_MALFORMED_REPLY(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZAP_MALFORMED_REPLY);
  return (ZMQ_PROTOCOL_ERROR_ZAP_MALFORMED_REPLY) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_UNSPECIFIED(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZAP_UNSPECIFIED);
  return (ZMQ_PROTOCOL_ERROR_ZAP_UNSPECIFIED) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_CRYPTOGRAPHIC(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_CRYPTOGRAPHIC);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_CRYPTOGRAPHIC) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_METADATA(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_METADATA);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_METADATA) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_SEQUENCE(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_SEQUENCE);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_SEQUENCE) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_KEY_EXCHANGE(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_KEY_EXCHANGE);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_KEY_EXCHANGE) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_ERROR(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_ERROR);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_ERROR) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_HELLO(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_HELLO);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_HELLO) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_INITIATE(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_INITIATE);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_INITIATE) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_MESSAGE(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_MESSAGE);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_MESSAGE) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_READY(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_READY);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_READY) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_UNSPECIFIED(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_UNSPECIFIED);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_UNSPECIFIED) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_WELCOME(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_WELCOME);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_WELCOME) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MECHANISM_MISMATCH(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_MECHANISM_MISMATCH);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_MECHANISM_MISMATCH) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_UNEXPECTED_COMMAND(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_UNEXPECTED_COMMAND);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_UNEXPECTED_COMMAND) <= 0;
}

int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_UNSPECIFIED(long long *out_value)
{
  *out_value = (long long)(ZMQ_PROTOCOL_ERROR_ZMTP_UNSPECIFIED);
  return (ZMQ_PROTOCOL_ERROR_ZMTP_UNSPECIFIED) <= 0;
}
...
int _cffi_const_ZMQ_ROUTER_NOTIFY(long long *out_value)
{
  *out_value = (long long)(ZMQ_ROUTER_NOTIFY);
  return (ZMQ_ROUTER_NOTIFY) <= 0;
}
...
int _cffi_const_ZMQ_ROUTING_ID(long long *out_value)
{
  *out_value = (long long)(ZMQ_ROUTING_ID);
  return (ZMQ_ROUTING_ID) <= 0;
}
...
int _cffi_const_ZMQ_THREAD_AFFINITY_CPU_ADD(long long *out_value)
{
  *out_value = (long long)(ZMQ_THREAD_AFFINITY_CPU_ADD);
  return (ZMQ_THREAD_AFFINITY_CPU_ADD) <= 0;
}

int _cffi_const_ZMQ_THREAD_AFFINITY_CPU_REMOVE(long long *out_value)
{
  *out_value = (long long)(ZMQ_THREAD_AFFINITY_CPU_REMOVE);
  return (ZMQ_THREAD_AFFINITY_CPU_REMOVE) <= 0;
}

int _cffi_const_ZMQ_THREAD_NAME_PREFIX(long long *out_value)
{
  *out_value = (long long)(ZMQ_THREAD_NAME_PREFIX);
  return (ZMQ_THREAD_NAME_PREFIX) <= 0;
}
...
int _cffi_const_ZMQ_ZAP_ENFORCE_DOMAIN(long long *out_value)
{
  *out_value = (long long)(ZMQ_ZAP_ENFORCE_DOMAIN);
  return (ZMQ_ZAP_ENFORCE_DOMAIN) <= 0;
}
