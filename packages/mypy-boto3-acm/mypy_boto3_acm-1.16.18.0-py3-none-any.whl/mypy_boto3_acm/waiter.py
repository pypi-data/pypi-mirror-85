...
class CertificateValidatedWaiter(Boto3Waiter):
    ...
    def wait(self, CertificateArn: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [CertificateValidated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.18/reference/services/acm.html#ACM.Waiter.CertificateValidated.wait)
        """
