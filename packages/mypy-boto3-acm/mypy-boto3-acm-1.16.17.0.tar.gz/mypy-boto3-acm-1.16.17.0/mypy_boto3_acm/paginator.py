...
class ListCertificatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListCertificates.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.17/reference/services/acm.html#ACM.Paginator.ListCertificates.paginate)
        """
