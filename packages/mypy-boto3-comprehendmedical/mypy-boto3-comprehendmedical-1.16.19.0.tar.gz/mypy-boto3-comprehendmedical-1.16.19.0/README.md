...
[boto3.ComprehendMedical 1.16.19](https://boto3.amazonaws.com/v1/documentation/api/1.16.19/reference/services/comprehendmedical.html#ComprehendMedical) service
compatible with
