/*! For license information please see chunk.a9a18b2bcbe509c8fdfa.js.LICENSE.txt */
...
`,is:"paper-icon-item",behaviors:[n.U]})},27849:(e,t,i)=>{"use strict";i(39841);var r=i(50856);i(28426);class o extends(customElements.get("app-header-layout")){static get template(){return r.d`
      ...
      ${this.cloudStatus&&(0,o.p)(this.hass,"cloud")?r.dy`
            <ha-card>
              <ha-config-navigation
                .hass=${this.hass}
                .showAdvanced=${this.showAdvanced}
                .pages=${[{component:"cloud",path:"/config/cloud",translationKey:"ui.panel.config.cloud.caption",info:this.cloudStatus,iconPath:s.UoA}]}
              ></ha-config-navigation>
            </ha-card>
          `:""}
    ...
    `:e}},{kind:"get",static:!0,key:"styles",value:function(){return[n.Qx,r.iv`
        app-header {
      ...
      `]}}]}}),r.oi)}}]);
//# sourceMappingURL=chunk.a9a18b2bcbe509c8fdfa.js.map