...
def generate_2d_square_matrix(v1, v2):
...
def generate_3d_square_matrix(v1, v2):
  (startX, startY, startZ) = (v1.x, v1.y, v1.z)
  (endX, endY, endZ) = (v2.x, v2.y, v2.z)
  matrix = []
  while startY < endY:
    row_x = []
    while startX < endX:
      ...
      while startZ < endZ:
        startZ += 1
        row_z.append(Vector3(startX, startY, startZ))
      startZ = v1.z
      startX += 1
      row_x.append(row_z)
    startX = v1.x
