...
class NodeAssociatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [NodeAssociated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.18/reference/services/opsworkscm.html#OpsWorksCM.Waiter.NodeAssociated.wait)
        """
